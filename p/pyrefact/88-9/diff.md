# Comparing `tmp/pyrefact-88.tar.gz` & `tmp/pyrefact-9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "pyrefact-88.tar", last modified: Mon Jun 26 22:46:41 2023, max compression
+gzip compressed data, was "pyrefact-9.tar", last modified: Wed Nov  2 20:30:27 2022, max compression
```

## Comparing `pyrefact-88.tar` & `pyrefact-9.tar`

### file list

```diff
@@ -1,34 +1,20 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-26 22:46:41.307131 pyrefact-88/
--rw-r--r--   0 runner    (1001) docker     (123)     1069 2023-06-26 22:46:29.000000 pyrefact-88/LICENSE
--rw-r--r--   0 runner    (1001) docker     (123)     6620 2023-06-26 22:46:41.307131 pyrefact-88/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)     5030 2023-06-26 22:46:29.000000 pyrefact-88/README.md
--rw-r--r--   0 runner    (1001) docker     (123)      779 2023-06-26 22:46:29.000000 pyrefact-88/pyproject.toml
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-26 22:46:41.307131 pyrefact-88/pyrefact/
--rw-r--r--   0 runner    (1001) docker     (123)       43 2023-06-26 22:46:29.000000 pyrefact-88/pyrefact/__init__.py
--rwxr-xr-x   0 runner    (1001) docker     (123)      127 2023-06-26 22:46:29.000000 pyrefact-88/pyrefact/__main__.py
--rw-r--r--   0 runner    (1001) docker     (123)    26458 2023-06-26 22:46:29.000000 pyrefact-88/pyrefact/abstractions.py
--rw-r--r--   0 runner    (1001) docker     (123)     9008 2023-06-26 22:46:29.000000 pyrefact-88/pyrefact/constants.py
--rw-r--r--   0 runner    (1001) docker     (123)    34184 2023-06-26 22:46:29.000000 pyrefact-88/pyrefact/core.py
--rw-r--r--   0 runner    (1001) docker     (123)   127313 2023-06-26 22:46:29.000000 pyrefact-88/pyrefact/fixes.py
--rw-r--r--   0 runner    (1001) docker     (123)     1697 2023-06-26 22:46:29.000000 pyrefact-88/pyrefact/formatting.py
--rw-r--r--   0 runner    (1001) docker     (123)     1007 2023-06-26 22:46:29.000000 pyrefact-88/pyrefact/logs.py
--rwxr-xr-x   0 runner    (1001) docker     (123)    13093 2023-06-26 22:46:29.000000 pyrefact-88/pyrefact/main.py
--rw-r--r--   0 runner    (1001) docker     (123)     8251 2023-06-26 22:46:29.000000 pyrefact-88/pyrefact/object_oriented.py
--rw-r--r--   0 runner    (1001) docker     (123)     8188 2023-06-26 22:46:29.000000 pyrefact-88/pyrefact/parsing.py
--rw-r--r--   0 runner    (1001) docker     (123)    11500 2023-06-26 22:46:29.000000 pyrefact-88/pyrefact/performance.py
--rw-r--r--   0 runner    (1001) docker     (123)     6843 2023-06-26 22:46:29.000000 pyrefact-88/pyrefact/performance_numpy.py
--rw-r--r--   0 runner    (1001) docker     (123)     6739 2023-06-26 22:46:29.000000 pyrefact-88/pyrefact/performance_pandas.py
--rw-r--r--   0 runner    (1001) docker     (123)    23318 2023-06-26 22:46:29.000000 pyrefact-88/pyrefact/processing.py
--rw-r--r--   0 runner    (1001) docker     (123)     1615 2023-06-26 22:46:29.000000 pyrefact-88/pyrefact/style.py
--rw-r--r--   0 runner    (1001) docker     (123)    33478 2023-06-26 22:46:29.000000 pyrefact-88/pyrefact/symbolic_math.py
--rw-r--r--   0 runner    (1001) docker     (123)    18125 2023-06-26 22:46:29.000000 pyrefact-88/pyrefact/tracing.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-26 22:46:41.307131 pyrefact-88/pyrefact.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)     6620 2023-06-26 22:46:41.000000 pyrefact-88/pyrefact.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      650 2023-06-26 22:46:41.000000 pyrefact-88/pyrefact.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-06-26 22:46:41.000000 pyrefact-88/pyrefact.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)       52 2023-06-26 22:46:41.000000 pyrefact-88/pyrefact.egg-info/entry_points.txt
--rw-r--r--   0 runner    (1001) docker     (123)       98 2023-06-26 22:46:41.000000 pyrefact-88/pyrefact.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)        9 2023-06-26 22:46:41.000000 pyrefact-88/pyrefact.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (123)       38 2023-06-26 22:46:41.307131 pyrefact-88/setup.cfg
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-26 22:46:41.307131 pyrefact-88/tests/
--rw-r--r--   0 runner    (1001) docker     (123)     2576 2023-06-26 22:46:29.000000 pyrefact-88/tests/testing_infra.py
...
### Comparing `pyrefact-88/LICENSE` & `pyrefact-9/LICENSE`

 * *Files identical despite different names*

### Comparing `pyrefact-88/pyrefact/abstractions.py` & `pyrefact-9/pyrefact/fixes.py`
