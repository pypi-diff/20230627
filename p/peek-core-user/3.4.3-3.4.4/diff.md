# Comparing `tmp/peek-core-user-3.4.3.tar.gz` & `tmp/peek-core-user-3.4.4.tar.gz`
...
### Comparing `peek-core-user-3.4.3/peek_core_user/__init__.py` & `peek-core-user-3.4.4/peek_core_user/__init__.py`
...
### Comparing `peek-core-user-3.4.3/peek_core_user/_private/admin-app/edit-internal-group-table/edit.component.html` & `peek-core-user-3.4.4/peek_core_user/_private/admin-app/edit-internal-group-table/edit.component.html`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/admin-app/edit-internal-group-table/edit.component.ts` & `peek-core-user-3.4.4/peek_core_user/_private/admin-app/edit-internal-group-table/edit.component.ts`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/admin-app/edit-internal-user-table/edit.component.html` & `peek-core-user-3.4.4/peek_core_user/_private/admin-app/edit-internal-user-table/edit.component.html`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/admin-app/edit-internal-user-table/edit.component.ts` & `peek-core-user-3.4.4/peek_core_user/_private/admin-app/edit-internal-user-table/edit.component.ts`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/admin-app/edit-ldap-setting-table/edit.component.html` & `peek-core-user-3.4.4/peek_core_user/_private/admin-app/edit-ldap-setting-table/edit.component.html`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/admin-app/edit-ldap-setting-table/edit.component.ts` & `peek-core-user-3.4.4/peek_core_user/_private/admin-app/edit-ldap-setting-table/edit.component.ts`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/admin-app/edit-setting-table/edit.component.html` & `peek-core-user-3.4.4/peek_core_user/_private/admin-app/edit-setting-table/edit.component.html`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/admin-app/edit-setting-table/edit.component.ts` & `peek-core-user-3.4.4/peek_core_user/_private/admin-app/edit-setting-table/edit.component.ts`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/admin-app/logged-in-user/logged-in-user.component.html` & `peek-core-user-3.4.4/peek_core_user/_private/admin-app/logged-in-user/logged-in-user.component.html`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/admin-app/logged-in-user/logged-in-user.component.ts` & `peek-core-user-3.4.4/peek_core_user/_private/admin-app/logged-in-user/logged-in-user.component.ts`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/admin-app/tuples/InternalGroupTuple.ts` & `peek-core-user-3.4.4/peek_core_user/_private/admin-app/tuples/InternalGroupTuple.ts`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/admin-app/tuples/InternalUserTuple.ts` & `peek-core-user-3.4.4/peek_core_user/_private/admin-app/tuples/InternalUserTuple.ts`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/admin-app/tuples/InternalUserUpdatePasswordAction.ts` & `peek-core-user-3.4.4/peek_core_user/_private/admin-app/tuples/InternalUserUpdatePasswordAction.ts`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/admin-app/tuples/LdapSettingTuple.ts` & `peek-core-user-3.4.4/peek_core_user/_private/admin-app/tuples/LdapSettingTuple.ts`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/admin-app/tuples/SettingPropertyTuple.ts` & `peek-core-user-3.4.4/peek_core_user/_private/admin-app/tuples/SettingPropertyTuple.ts`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/admin-app/user.component.html` & `peek-core-user-3.4.4/peek_core_user/_private/admin-app/user.component.html`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/admin-app/user.module.ts` & `peek-core-user-3.4.4/peek_core_user/_private/admin-app/user.module.ts`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/agent/AgentEntryHook.py` & `peek-core-user-3.4.4/peek_core_user/_private/agent/AgentEntryHook.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/agent/RpcForLogic.py` & `peek-core-user-3.4.4/peek_core_user/_private/agent/RpcForLogic.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/alembic/script.py.mako` & `peek-core-user-3.4.4/peek_core_user/_private/alembic/script.py.mako`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/alembic/versions/0498d92479c8_implemented_internal_directory.py` & `peek-core-user-3.4.4/peek_core_user/_private/alembic/versions/0498d92479c8_implemented_internal_directory.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/alembic/versions/1176bc54abf3_added_foreign_key_to_user_logged_in.py` & `peek-core-user-3.4.4/peek_core_user/_private/alembic/versions/1176bc54abf3_added_foreign_key_to_user_logged_in.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/alembic/versions/2209cf338e6d_added_ldap_table.py` & `peek-core-user-3.4.4/peek_core_user/_private/alembic/versions/2209cf338e6d_added_ldap_table.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/alembic/versions/2c6728ebc562_separated_password.py` & `peek-core-user-3.4.4/peek_core_user/_private/alembic/versions/2c6728ebc562_separated_password.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/alembic/versions/3a9cddaf05e5_added_settings_table.py` & `peek-core-user-3.4.4/peek_core_user/_private/alembic/versions/3a9cddaf05e5_added_settings_table.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/alembic/versions/3fd59734e444_removed_string_limits.py` & `peek-core-user-3.4.4/peek_core_user/_private/alembic/versions/3fd59734e444_removed_string_limits.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/alembic/versions/3fec57d8da58_initial.py` & `peek-core-user-3.4.4/peek_core_user/_private/alembic/versions/3fec57d8da58_initial.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/alembic/versions/43df0e05c728_added_user_import_source.py` & `peek-core-user-3.4.4/peek_core_user/_private/alembic/versions/43df0e05c728_added_user_import_source.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/alembic/versions/45c62f8acd87_added_vehical_to_loggedin.py` & `peek-core-user-3.4.4/peek_core_user/_private/alembic/versions/45c62f8acd87_added_vehical_to_loggedin.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/alembic/versions/56d805072d2a_added_importhash.py` & `peek-core-user-3.4.4/peek_core_user/_private/alembic/versions/56d805072d2a_added_importhash.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/alembic/versions/5e33c6b788fd_removed_unique_logged_in_user.py` & `peek-core-user-3.4.4/peek_core_user/_private/alembic/versions/5e33c6b788fd_removed_unique_logged_in_user.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/alembic/versions/73d65f042834_removed_foreign_key_from_user_logged_in.py` & `peek-core-user-3.4.4/peek_core_user/_private/alembic/versions/73d65f042834_removed_foreign_key_from_user_logged_in.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/alembic/versions/7e3f668edf0e_updated_settings.py` & `peek-core-user-3.4.4/peek_core_user/_private/alembic/versions/7e3f668edf0e_updated_settings.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/alembic/versions/9b65be31926e_timezone_aware.py` & `peek-core-user-3.4.4/peek_core_user/_private/alembic/versions/9b65be31926e_timezone_aware.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/alembic/versions/b09fe7b3b31b_add_userkey.py` & `peek-core-user-3.4.4/peek_core_user/_private/alembic/versions/b09fe7b3b31b_add_userkey.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/alembic/versions/d03db0fcb600_convert_userkey_and_username_to_all_.py` & `peek-core-user-3.4.4/peek_core_user/_private/alembic/versions/d03db0fcb600_convert_userkey_and_username_to_all_.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/alembic/versions/d79da9333e2a_drop_internaluser_rows_from_ldap_for_useruuid_change.py` & `peek-core-user-3.4.4/peek_core_user/_private/alembic/versions/d79da9333e2a_drop_internaluser_rows_from_ldap_for_useruuid_change.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/alembic/versions/eef485ef2e0e_added_agenturi_column_to_ldapsetting.py` & `peek-core-user-3.4.4/peek_core_user/_private/alembic/versions/eef485ef2e0e_added_agenturi_column_to_ldapsetting.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/both-app/plugin-user.module.ts` & `peek-core-user-3.4.4/peek_core_user/_private/both-app/plugin-user.module.ts`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/both-app/plugin-user.routes.ts` & `peek-core-user-3.4.4/peek_core_user/_private/both-app/plugin-user.routes.ts`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/both-app/scss/plugin-user.dweb.scss` & `peek-core-user-3.4.4/peek_core_user/_private/both-app/scss/plugin-user.dweb.scss`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/both-app/scss/plugin-user.mweb.scss` & `peek-core-user-3.4.4/peek_core_user/_private/both-app/scss/plugin-user.mweb.scss`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/both-app/tuples/UserLoginUiSettingTuple.ts` & `peek-core-user-3.4.4/peek_core_user/_private/both-app/tuples/UserLoginUiSettingTuple.ts`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/both-app/user-login/user-login.component.dweb.html` & `peek-core-user-3.4.4/peek_core_user/_private/both-app/user-login/user-login.component.dweb.html`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/both-app/user-login/user-login.component.mweb.html` & `peek-core-user-3.4.4/peek_core_user/_private/both-app/user-login/user-login.component.mweb.html`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/both-app/user-login/user-login.component.ts` & `peek-core-user-3.4.4/peek_core_user/_private/both-app/user-login/user-login.component.ts`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/both-app/user-logout/user-logout.component.dweb.html` & `peek-core-user-3.4.4/peek_core_user/_private/both-app/user-logout/user-logout.component.dweb.html`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/both-app/user-logout/user-logout.component.mweb.html` & `peek-core-user-3.4.4/peek_core_user/_private/both-app/user-logout/user-logout.component.mweb.html`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/both-app/user-logout/user-logout.component.ts` & `peek-core-user-3.4.4/peek_core_user/_private/both-app/user-logout/user-logout.component.ts`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/both-assets/plugin_icon.png` & `peek-core-user-3.4.4/peek_core_user/_private/both-assets/plugin_icon.png`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/client/PluginClientEntryHook.py` & `peek-core-user-3.4.4/peek_core_user/_private/client/PluginClientEntryHook.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/ldap_auth/ldap_auth.py` & `peek-core-user-3.4.4/peek_core_user/_private/ldap_auth/ldap_auth.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/server/AdminTupleDataObservable.py` & `peek-core-user-3.4.4/peek_core_user/_private/server/AdminTupleDataObservable.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/server/ClientTupleActionProcessor.py` & `peek-core-user-3.4.4/peek_core_user/_private/server/ClientTupleActionProcessor.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/server/ClientTupleDataObservable.py` & `peek-core-user-3.4.4/peek_core_user/_private/server/ClientTupleDataObservable.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/server/PluginLogicEntryHook.py` & `peek-core-user-3.4.4/peek_core_user/_private/server/PluginLogicEntryHook.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/server/admin_backend/InternalGroupTableHandler.py` & `peek-core-user-3.4.4/peek_core_user/_private/server/admin_backend/InternalGroupTableHandler.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/server/admin_backend/InternalUserTableHandler.py` & `peek-core-user-3.4.4/peek_core_user/_private/server/admin_backend/InternalUserTableHandler.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/server/admin_backend/LdapSettingsHandler.py` & `peek-core-user-3.4.4/peek_core_user/_private/server/admin_backend/LdapSettingsHandler.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/server/admin_backend/SettingPropertyHandler.py` & `peek-core-user-3.4.4/peek_core_user/_private/server/admin_backend/SettingPropertyHandler.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/server/admin_backend/__init__.py` & `peek-core-user-3.4.4/peek_core_user/_private/server/admin_backend/__init__.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/server/admin_tuple_providers/LoggedInUserStatusTupleProvider.py` & `peek-core-user-3.4.4/peek_core_user/_private/server/admin_tuple_providers/LoggedInUserStatusTupleProvider.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/server/api/UserAdminAuthApi.py` & `peek-core-user-3.4.4/peek_core_user/_private/server/api/UserAdminAuthApi.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/server/api/UserApi.py` & `peek-core-user-3.4.4/peek_core_user/_private/server/api/UserApi.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/server/api/UserFieldHookApi.py` & `peek-core-user-3.4.4/peek_core_user/_private/server/api/UserFieldHookApi.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/server/api/UserImportApi.py` & `peek-core-user-3.4.4/peek_core_user/_private/server/api/UserImportApi.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/server/api/UserInfoApi.py` & `peek-core-user-3.4.4/peek_core_user/_private/server/api/UserInfoApi.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/server/api/UserLoginApi.py` & `peek-core-user-3.4.4/peek_core_user/_private/server/api/UserLoginApi.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/server/auth_connectors/AuthABC.py` & `peek-core-user-3.4.4/peek_core_user/_private/server/auth_connectors/AuthABC.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/server/auth_connectors/InternalAuth.py` & `peek-core-user-3.4.4/peek_core_user/_private/server/auth_connectors/InternalAuth.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/server/auth_connectors/LdapAuth.py` & `peek-core-user-3.4.4/peek_core_user/_private/server/auth_connectors/LdapAuth.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/server/controller/AdminAuthController.py` & `peek-core-user-3.4.4/peek_core_user/_private/server/controller/AdminAuthController.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/server/controller/ImportController.py` & `peek-core-user-3.4.4/peek_core_user/_private/server/controller/ImportController.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/server/controller/LoginLogoutController.py` & `peek-core-user-3.4.4/peek_core_user/_private/server/controller/LoginLogoutController.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/server/controller/MainController.py` & `peek-core-user-3.4.4/peek_core_user/_private/server/controller/MainController.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/server/controller/PasswordUpdateController.py` & `peek-core-user-3.4.4/peek_core_user/_private/server/controller/PasswordUpdateController.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/server/tuple_providers/GroupDetailTupleProvider.py` & `peek-core-user-3.4.4/peek_core_user/_private/server/tuple_providers/GroupDetailTupleProvider.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/server/tuple_providers/UserListItemTupleProvider.py` & `peek-core-user-3.4.4/peek_core_user/_private/server/tuple_providers/UserListItemTupleProvider.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/server/tuple_providers/UserLoggedInTupleProvider.py` & `peek-core-user-3.4.4/peek_core_user/_private/server/tuple_providers/UserLoggedInTupleProvider.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/server/tuple_providers/UserLoginUiSettingTupleProvider.py` & `peek-core-user-3.4.4/peek_core_user/_private/server/tuple_providers/UserLoginUiSettingTupleProvider.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/storage/DeclarativeBase.py` & `peek-core-user-3.4.4/peek_core_user/_private/storage/DeclarativeBase.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/storage/DirectoryTuple.py` & `peek-core-user-3.4.4/peek_core_user/_private/storage/DirectoryTuple.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/storage/InternalGroupTuple.py` & `peek-core-user-3.4.4/peek_core_user/_private/storage/InternalGroupTuple.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/storage/InternalUserGroupTuple.py` & `peek-core-user-3.4.4/peek_core_user/_private/storage/InternalUserGroupTuple.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/storage/InternalUserPassword.py` & `peek-core-user-3.4.4/peek_core_user/_private/storage/InternalUserPassword.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/storage/InternalUserTuple.py` & `peek-core-user-3.4.4/peek_core_user/_private/storage/InternalUserTuple.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/storage/LdapSetting.py` & `peek-core-user-3.4.4/peek_core_user/_private/storage/LdapSetting.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/storage/Setting.py` & `peek-core-user-3.4.4/peek_core_user/_private/storage/Setting.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/storage/UserLoggedIn.py` & `peek-core-user-3.4.4/peek_core_user/_private/storage/UserLoggedIn.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/tuples/InternalGroupImportResultTuple.py` & `peek-core-user-3.4.4/peek_core_user/_private/tuples/InternalGroupImportResultTuple.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/tuples/InternalUserImportResultTuple.py` & `peek-core-user-3.4.4/peek_core_user/_private/tuples/InternalUserImportResultTuple.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/tuples/LdapLoggedInUserTuple.py` & `peek-core-user-3.4.4/peek_core_user/_private/tuples/LdapLoggedInUserTuple.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/tuples/LoggedInUserStatusTuple.py` & `peek-core-user-3.4.4/peek_core_user/_private/tuples/LoggedInUserStatusTuple.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/tuples/UserLoggedInTuple.py` & `peek-core-user-3.4.4/peek_core_user/_private/tuples/UserLoggedInTuple.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/worker/WorkerEntryHook.py` & `peek-core-user-3.4.4/peek_core_user/_private/worker/WorkerEntryHook.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/worker/tasks/UserImportInternalGroupTask.py` & `peek-core-user-3.4.4/peek_core_user/_private/worker/tasks/UserImportInternalGroupTask.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/_private/worker/tasks/UserImportInternalUserTask.py` & `peek-core-user-3.4.4/peek_core_user/_private/worker/tasks/UserImportInternalUserTask.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/admin-doc/configuration/add_group.png` & `peek-core-user-3.4.4/peek_core_user/admin-doc/configuration/add_group.png`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/admin-doc/configuration/add_user.png` & `peek-core-user-3.4.4/peek_core_user/admin-doc/configuration/add_user.png`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/admin-doc/configuration/configuration.rst` & `peek-core-user-3.4.4/peek_core_user/admin-doc/configuration/configuration.rst`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/admin-doc/configuration/edit-internal-groups.png` & `peek-core-user-3.4.4/peek_core_user/admin-doc/configuration/edit-internal-groups.png`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/admin-doc/configuration/edit-internal-user.png` & `peek-core-user-3.4.4/peek_core_user/admin-doc/configuration/edit-internal-user.png`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/admin-doc/configuration/settings-general.png` & `peek-core-user-3.4.4/peek_core_user/admin-doc/configuration/settings-general.png`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/admin-doc/configuration/settings-ldap.png` & `peek-core-user-3.4.4/peek_core_user/admin-doc/configuration/settings-ldap.png`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/admin-doc/logged_in/logged_in.rst` & `peek-core-user-3.4.4/peek_core_user/admin-doc/logged_in/logged_in.rst`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/admin-doc/logged_in/logout_user.png` & `peek-core-user-3.4.4/peek_core_user/admin-doc/logged_in/logout_user.png`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/admin-doc/logged_in/logout_yes.png` & `peek-core-user-3.4.4/peek_core_user/admin-doc/logged_in/logout_yes.png`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/admin-doc/logged_in/manage-logged-in-users.png` & `peek-core-user-3.4.4/peek_core_user/admin-doc/logged_in/manage-logged-in-users.png`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/admin-doc/overview.rst` & `peek-core-user-3.4.4/peek_core_user/admin-doc/overview.rst`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/both-doc/login.png` & `peek-core-user-3.4.4/peek_core_user/both-doc/login.png`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/both-doc/login_logout.png` & `peek-core-user-3.4.4/peek_core_user/both-doc/login_logout.png`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/both-doc/login_logout.rst` & `peek-core-user-3.4.4/peek_core_user/both-doc/login_logout.rst`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/both-doc/user_button.png` & `peek-core-user-3.4.4/peek_core_user/both-doc/user_button.png`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/plugin-module/_private/tuples/LoggedInUserStatusTuple.ts` & `peek-core-user-3.4.4/peek_core_user/plugin-module/_private/tuples/LoggedInUserStatusTuple.ts`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/plugin-module/_private/tuples/UserLoggedInTuple.ts` & `peek-core-user-3.4.4/peek_core_user/plugin-module/_private/tuples/UserLoggedInTuple.ts`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/plugin-module/_private/user-tuple.service.ts` & `peek-core-user-3.4.4/peek_core_user/plugin-module/_private/user-tuple.service.ts`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/plugin-module/index.ts` & `peek-core-user-3.4.4/peek_core_user/plugin-module/index.ts`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/plugin-module/services/logged-in.guard.ts` & `peek-core-user-3.4.4/peek_core_user/plugin-module/services/logged-in.guard.ts`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/plugin-module/services/user.service.ts` & `peek-core-user-3.4.4/peek_core_user/plugin-module/services/user.service.ts`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/plugin-module/tuples/UserDetailTuple.ts` & `peek-core-user-3.4.4/peek_core_user/plugin-module/tuples/UserDetailTuple.ts`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/plugin-module/tuples/UserListItemTuple.ts` & `peek-core-user-3.4.4/peek_core_user/plugin-module/tuples/UserListItemTuple.ts`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/plugin-module/tuples/login/UserLoginAction.ts` & `peek-core-user-3.4.4/peek_core_user/plugin-module/tuples/login/UserLoginAction.ts`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/plugin-module/tuples/login/UserLoginResponseTuple.ts` & `peek-core-user-3.4.4/peek_core_user/plugin-module/tuples/login/UserLoginResponseTuple.ts`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/plugin-module/tuples/login/UserLogoutAction.ts` & `peek-core-user-3.4.4/peek_core_user/plugin-module/tuples/login/UserLogoutAction.ts`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/plugin-module/tuples/login/UserLogoutResponseTuple.ts` & `peek-core-user-3.4.4/peek_core_user/plugin-module/tuples/login/UserLogoutResponseTuple.ts`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/plugin_package.json` & `peek-core-user-3.4.4/peek_core_user/plugin_package.json`
...
### Comparing `peek-core-user-3.4.3/peek_core_user/server/UserApiABC.py` & `peek-core-user-3.4.4/peek_core_user/server/UserApiABC.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/server/UserDbErrors.py` & `peek-core-user-3.4.4/peek_core_user/server/UserDbErrors.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/server/UserFieldHookApiABC.py` & `peek-core-user-3.4.4/peek_core_user/server/UserFieldHookApiABC.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/server/UserImportApiABC.py` & `peek-core-user-3.4.4/peek_core_user/server/UserImportApiABC.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/server/UserInfoApiABC.py` & `peek-core-user-3.4.4/peek_core_user/server/UserInfoApiABC.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/server/UserLoginApiABC.py` & `peek-core-user-3.4.4/peek_core_user/server/UserLoginApiABC.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/tuples/DeviceWithUserDetails.py` & `peek-core-user-3.4.4/peek_core_user/tuples/DeviceWithUserDetails.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/tuples/UserDetailTuple.py` & `peek-core-user-3.4.4/peek_core_user/tuples/UserDetailTuple.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/tuples/UserListItemTuple.py` & `peek-core-user-3.4.4/peek_core_user/tuples/UserListItemTuple.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/tuples/UserLoggedInInfoTuple.py` & `peek-core-user-3.4.4/peek_core_user/tuples/UserLoggedInInfoTuple.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/tuples/import_/ImportInternalUserTuple.py` & `peek-core-user-3.4.4/peek_core_user/tuples/import_/ImportInternalUserTuple.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/tuples/login/UserLoginAction.py` & `peek-core-user-3.4.4/peek_core_user/tuples/login/UserLoginAction.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/tuples/login/UserLoginResponseTuple.py` & `peek-core-user-3.4.4/peek_core_user/tuples/login/UserLoginResponseTuple.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/tuples/login/UserLogoutAction.py` & `peek-core-user-3.4.4/peek_core_user/tuples/login/UserLogoutAction.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user/tuples/login/UserLogoutResponseTuple.py` & `peek-core-user-3.4.4/peek_core_user/tuples/login/UserLogoutResponseTuple.py`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/peek_core_user.egg-info/SOURCES.txt` & `peek-core-user-3.4.4/peek_core_user.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `peek-core-user-3.4.3/setup.py` & `peek-core-user-3.4.4/setup.py`
