# Comparing `tmp/pyfsig-0.6.tar.gz` & `tmp/pyfsig-0.7.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "dist/pyfsig-0.6.tar", last modified: Sun Feb 26 13:21:29 2017, max compression
+gzip compressed data, was "pyfsig-0.7.0.tar", max compression
```

## Comparing `pyfsig-0.6.tar` & `pyfsig-0.7.0.tar`

### file list

```diff
@@ -1,8 +1,6 @@
-drwxr-xr-x   0 schlerp   (1000) schlerp   (1000)        0 2017-02-26 13:21:29.000000 pyfsig-0.6/
-drwxr-xr-x   0 schlerp   (1000) schlerp   (1000)        0 2017-02-26 13:21:29.000000 pyfsig-0.6/src/
-drwxr-xr-x   0 schlerp   (1000) schlerp   (1000)        0 2017-02-26 13:21:29.000000 pyfsig-0.6/src/pyfsig/
--rw-r--r--   0 schlerp   (1000) schlerp   (1000)      223 2017-02-26 12:40:51.000000 pyfsig-0.6/src/pyfsig/__init__.py
--rw-r--r--   0 schlerp   (1000) schlerp   (1000)    48494 2017-02-26 13:20:58.000000 pyfsig-0.6/src/pyfsig/file_signatures.py
--rw-r--r--   0 schlerp   (1000) schlerp   (1000)    54734 2017-02-26 13:21:11.000000 pyfsig-0.6/README
--rw-r--r--   0 schlerp   (1000) schlerp   (1000)      727 2017-02-26 13:21:03.000000 pyfsig-0.6/setup.py
--rw-r--r--   0 schlerp   (1000) schlerp   (1000)    64851 2017-02-26 13:21:29.000000 pyfsig-0.6/PKG-INFO
...
### Comparing `pyfsig-0.6/src/pyfsig/file_signatures.py` & `pyfsig-0.7.0/README.md`
...
### Comparing `pyfsig-0.6/README` & `pyfsig-0.7.0/PKG-INFO`
