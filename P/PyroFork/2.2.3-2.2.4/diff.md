# Comparing `tmp/PyroFork-2.2.3.tar.gz` & `tmp/PyroFork-2.2.4.tar.gz`
...
--rw-r--r--   0 runner    (1001) docker     (123)     8208 2023-06-22 17:38:29.000000 PyroFork-2.2.3/tests/test_file_id.py
...
### Comparing `PyroFork-2.2.3/COPYING` & `PyroFork-2.2.4/COPYING`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/COPYING.lesser` & `PyroFork-2.2.4/COPYING.lesser`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/NOTICE` & `PyroFork-2.2.4/NOTICE`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/PKG-INFO` & `PyroFork-2.2.4/PKG-INFO`
...
```diff
@@ -1,8 +1,8 @@
-Metadata-Version: 2.1 Name: PyroFork Version: 2.2.3 Summary: Elegant, modern
...
### Comparing `PyroFork-2.2.3/PyroFork.egg-info/PKG-INFO` & `PyroFork-2.2.4/PyroFork.egg-info/PKG-INFO`
...
### Comparing `PyroFork-2.2.3/PyroFork.egg-info/SOURCES.txt` & `PyroFork-2.2.4/PyroFork.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/README.md` & `PyroFork-2.2.4/README.md`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/compiler/__init__.py` & `PyroFork-2.2.4/compiler/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/compiler/api/__init__.py` & `PyroFork-2.2.4/compiler/api/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/compiler/api/compiler.py` & `PyroFork-2.2.4/compiler/api/compiler.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/compiler/api/source/auth_key.tl` & `PyroFork-2.2.4/compiler/api/source/auth_key.tl`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/compiler/api/source/main_api.tl` & `PyroFork-2.2.4/compiler/api/source/main_api.tl`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/compiler/api/source/sys_msgs.tl` & `PyroFork-2.2.4/compiler/api/source/sys_msgs.tl`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/compiler/api/template/combinator.txt` & `PyroFork-2.2.4/compiler/api/template/combinator.txt`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/compiler/api/template/type.txt` & `PyroFork-2.2.4/compiler/api/template/type.txt`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/compiler/docs/__init__.py` & `PyroFork-2.2.4/compiler/docs/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/compiler/docs/compiler.py` & `PyroFork-2.2.4/compiler/docs/compiler.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/compiler/errors/__init__.py` & `PyroFork-2.2.4/compiler/errors/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/compiler/errors/compiler.py` & `PyroFork-2.2.4/compiler/errors/compiler.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/compiler/errors/sort.py` & `PyroFork-2.2.4/compiler/errors/sort.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/compiler/errors/source/400_BAD_REQUEST.tsv` & `PyroFork-2.2.4/compiler/errors/source/400_BAD_REQUEST.tsv`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/compiler/errors/source/401_UNAUTHORIZED.tsv` & `PyroFork-2.2.4/compiler/errors/source/401_UNAUTHORIZED.tsv`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/compiler/errors/source/403_FORBIDDEN.tsv` & `PyroFork-2.2.4/compiler/errors/source/403_FORBIDDEN.tsv`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/compiler/errors/source/406_NOT_ACCEPTABLE.tsv` & `PyroFork-2.2.4/compiler/errors/source/406_NOT_ACCEPTABLE.tsv`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/compiler/errors/source/500_INTERNAL_SERVER_ERROR.tsv` & `PyroFork-2.2.4/compiler/errors/source/500_INTERNAL_SERVER_ERROR.tsv`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/__init__.py` & `PyroFork-2.2.4/pyrogram/__init__.py`
...
### Comparing `PyroFork-2.2.3/pyrogram/client.py` & `PyroFork-2.2.4/pyrogram/client.py`
...
### Comparing `PyroFork-2.2.3/pyrogram/connection/__init__.py` & `PyroFork-2.2.4/pyrogram/connection/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/connection/connection.py` & `PyroFork-2.2.4/pyrogram/connection/connection.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/connection/transport/__init__.py` & `PyroFork-2.2.4/pyrogram/connection/transport/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/connection/transport/tcp/__init__.py` & `PyroFork-2.2.4/pyrogram/connection/transport/tcp/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/connection/transport/tcp/tcp.py` & `PyroFork-2.2.4/pyrogram/connection/transport/tcp/tcp.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/connection/transport/tcp/tcp_abridged.py` & `PyroFork-2.2.4/pyrogram/connection/transport/tcp/tcp_abridged.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/connection/transport/tcp/tcp_abridged_o.py` & `PyroFork-2.2.4/pyrogram/connection/transport/tcp/tcp_abridged_o.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/connection/transport/tcp/tcp_full.py` & `PyroFork-2.2.4/pyrogram/connection/transport/tcp/tcp_full.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/connection/transport/tcp/tcp_intermediate.py` & `PyroFork-2.2.4/pyrogram/connection/transport/tcp/tcp_intermediate.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/connection/transport/tcp/tcp_intermediate_o.py` & `PyroFork-2.2.4/pyrogram/connection/transport/tcp/tcp_intermediate_o.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/crypto/__init__.py` & `PyroFork-2.2.4/pyrogram/crypto/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/crypto/aes.py` & `PyroFork-2.2.4/pyrogram/crypto/aes.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/crypto/mtproto.py` & `PyroFork-2.2.4/pyrogram/crypto/mtproto.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/crypto/prime.py` & `PyroFork-2.2.4/pyrogram/crypto/prime.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/crypto/rsa.py` & `PyroFork-2.2.4/pyrogram/crypto/rsa.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/dispatcher.py` & `PyroFork-2.2.4/pyrogram/dispatcher.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/emoji.py` & `PyroFork-2.2.4/pyrogram/emoji.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/enums/__init__.py` & `PyroFork-2.2.4/pyrogram/enums/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/enums/auto_name.py` & `PyroFork-2.2.4/pyrogram/enums/auto_name.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/enums/chat_action.py` & `PyroFork-2.2.4/pyrogram/enums/chat_action.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/enums/chat_event_action.py` & `PyroFork-2.2.4/pyrogram/enums/chat_event_action.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/enums/chat_member_status.py` & `PyroFork-2.2.4/pyrogram/enums/chat_member_status.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/enums/chat_members_filter.py` & `PyroFork-2.2.4/pyrogram/enums/chat_members_filter.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/enums/chat_type.py` & `PyroFork-2.2.4/pyrogram/enums/chat_type.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/enums/message_entity_type.py` & `PyroFork-2.2.4/pyrogram/enums/message_entity_type.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/enums/message_media_type.py` & `PyroFork-2.2.4/pyrogram/enums/message_media_type.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/enums/message_service_type.py` & `PyroFork-2.2.4/pyrogram/enums/message_service_type.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/enums/messages_filter.py` & `PyroFork-2.2.4/pyrogram/enums/messages_filter.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/enums/next_code_type.py` & `PyroFork-2.2.4/pyrogram/enums/next_code_type.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/enums/parse_mode.py` & `PyroFork-2.2.4/pyrogram/enums/parse_mode.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/enums/poll_type.py` & `PyroFork-2.2.4/pyrogram/enums/poll_type.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/enums/sent_code_type.py` & `PyroFork-2.2.4/pyrogram/enums/sent_code_type.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/enums/user_status.py` & `PyroFork-2.2.4/pyrogram/enums/user_status.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/errors/__init__.py` & `PyroFork-2.2.4/pyrogram/errors/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/errors/rpc_error.py` & `PyroFork-2.2.4/pyrogram/errors/rpc_error.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/file_id.py` & `PyroFork-2.2.4/pyrogram/file_id.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/filters.py` & `PyroFork-2.2.4/pyrogram/filters.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/handlers/__init__.py` & `PyroFork-2.2.4/pyrogram/handlers/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/handlers/callback_query_handler.py` & `PyroFork-2.2.4/pyrogram/handlers/callback_query_handler.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/handlers/chat_join_request_handler.py` & `PyroFork-2.2.4/pyrogram/handlers/chat_join_request_handler.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/handlers/chat_member_updated_handler.py` & `PyroFork-2.2.4/pyrogram/handlers/chat_member_updated_handler.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/handlers/chosen_inline_result_handler.py` & `PyroFork-2.2.4/pyrogram/handlers/chosen_inline_result_handler.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/handlers/deleted_messages_handler.py` & `PyroFork-2.2.4/pyrogram/handlers/deleted_messages_handler.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/handlers/disconnect_handler.py` & `PyroFork-2.2.4/pyrogram/handlers/disconnect_handler.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/handlers/edited_message_handler.py` & `PyroFork-2.2.4/pyrogram/handlers/edited_message_handler.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/handlers/handler.py` & `PyroFork-2.2.4/pyrogram/handlers/handler.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/handlers/inline_query_handler.py` & `PyroFork-2.2.4/pyrogram/handlers/inline_query_handler.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/handlers/message_handler.py` & `PyroFork-2.2.4/pyrogram/handlers/message_handler.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/handlers/poll_handler.py` & `PyroFork-2.2.4/pyrogram/handlers/poll_handler.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/handlers/raw_update_handler.py` & `PyroFork-2.2.4/pyrogram/handlers/raw_update_handler.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/handlers/user_status_handler.py` & `PyroFork-2.2.4/pyrogram/handlers/user_status_handler.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/__init__.py` & `PyroFork-2.2.4/pyrogram/methods/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/advanced/__init__.py` & `PyroFork-2.2.4/pyrogram/methods/advanced/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/advanced/invoke.py` & `PyroFork-2.2.4/pyrogram/methods/advanced/invoke.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/advanced/resolve_peer.py` & `PyroFork-2.2.4/pyrogram/methods/advanced/resolve_peer.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/advanced/save_file.py` & `PyroFork-2.2.4/pyrogram/methods/advanced/save_file.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/auth/__init__.py` & `PyroFork-2.2.4/pyrogram/methods/auth/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/auth/accept_terms_of_service.py` & `PyroFork-2.2.4/pyrogram/methods/auth/accept_terms_of_service.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/auth/check_password.py` & `PyroFork-2.2.4/pyrogram/methods/auth/check_password.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/auth/connect.py` & `PyroFork-2.2.4/pyrogram/methods/auth/connect.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/auth/disconnect.py` & `PyroFork-2.2.4/pyrogram/methods/auth/disconnect.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/auth/get_password_hint.py` & `PyroFork-2.2.4/pyrogram/methods/auth/get_password_hint.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/auth/initialize.py` & `PyroFork-2.2.4/pyrogram/methods/auth/initialize.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/auth/log_out.py` & `PyroFork-2.2.4/pyrogram/methods/auth/log_out.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/auth/recover_password.py` & `PyroFork-2.2.4/pyrogram/methods/auth/recover_password.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/auth/resend_code.py` & `PyroFork-2.2.4/pyrogram/methods/auth/resend_code.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/auth/send_code.py` & `PyroFork-2.2.4/pyrogram/methods/auth/send_code.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/auth/send_recovery_code.py` & `PyroFork-2.2.4/pyrogram/methods/auth/send_recovery_code.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/auth/sign_in.py` & `PyroFork-2.2.4/pyrogram/methods/auth/sign_in.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/auth/sign_in_bot.py` & `PyroFork-2.2.4/pyrogram/methods/auth/sign_in_bot.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/auth/sign_up.py` & `PyroFork-2.2.4/pyrogram/methods/auth/sign_up.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/auth/terminate.py` & `PyroFork-2.2.4/pyrogram/methods/auth/terminate.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/bots/__init__.py` & `PyroFork-2.2.4/pyrogram/methods/bots/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/bots/answer_callback_query.py` & `PyroFork-2.2.4/pyrogram/methods/bots/answer_callback_query.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/bots/answer_inline_query.py` & `PyroFork-2.2.4/pyrogram/methods/bots/answer_inline_query.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/bots/answer_web_app_query.py` & `PyroFork-2.2.4/pyrogram/methods/bots/answer_web_app_query.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/bots/delete_bot_commands.py` & `PyroFork-2.2.4/pyrogram/methods/bots/delete_bot_commands.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/bots/get_bot_commands.py` & `PyroFork-2.2.4/pyrogram/methods/bots/get_bot_commands.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/bots/get_bot_default_privileges.py` & `PyroFork-2.2.4/pyrogram/methods/bots/get_bot_default_privileges.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/bots/get_chat_menu_button.py` & `PyroFork-2.2.4/pyrogram/methods/bots/get_chat_menu_button.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/bots/get_game_high_scores.py` & `PyroFork-2.2.4/pyrogram/methods/bots/get_game_high_scores.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/bots/get_inline_bot_results.py` & `PyroFork-2.2.4/pyrogram/methods/bots/get_inline_bot_results.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/bots/request_callback_answer.py` & `PyroFork-2.2.4/pyrogram/methods/bots/request_callback_answer.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/bots/send_game.py` & `PyroFork-2.2.4/pyrogram/methods/bots/send_game.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/bots/send_inline_bot_result.py` & `PyroFork-2.2.4/pyrogram/methods/bots/send_inline_bot_result.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/bots/set_bot_commands.py` & `PyroFork-2.2.4/pyrogram/methods/bots/set_bot_commands.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/bots/set_bot_default_privileges.py` & `PyroFork-2.2.4/pyrogram/methods/bots/set_bot_default_privileges.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/bots/set_chat_menu_button.py` & `PyroFork-2.2.4/pyrogram/methods/bots/set_chat_menu_button.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/bots/set_game_score.py` & `PyroFork-2.2.4/pyrogram/methods/bots/set_game_score.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/__init__.py` & `PyroFork-2.2.4/pyrogram/methods/chats/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/add_chat_members.py` & `PyroFork-2.2.4/pyrogram/methods/chats/add_chat_members.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/archive_chats.py` & `PyroFork-2.2.4/pyrogram/methods/chats/archive_chats.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/ban_chat_member.py` & `PyroFork-2.2.4/pyrogram/methods/chats/ban_chat_member.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/close_forum_topic.py` & `PyroFork-2.2.4/pyrogram/methods/chats/close_forum_topic.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/close_general_topic.py` & `PyroFork-2.2.4/pyrogram/methods/chats/close_general_topic.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/create_channel.py` & `PyroFork-2.2.4/pyrogram/methods/chats/create_channel.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/create_forum_topic.py` & `PyroFork-2.2.4/pyrogram/methods/chats/create_forum_topic.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/create_group.py` & `PyroFork-2.2.4/pyrogram/methods/chats/create_group.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/create_supergroup.py` & `PyroFork-2.2.4/pyrogram/methods/chats/create_supergroup.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/delete_channel.py` & `PyroFork-2.2.4/pyrogram/methods/chats/delete_channel.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/delete_chat_photo.py` & `PyroFork-2.2.4/pyrogram/methods/chats/delete_chat_photo.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/delete_forum_topic.py` & `PyroFork-2.2.4/pyrogram/methods/chats/delete_forum_topic.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/delete_supergroup.py` & `PyroFork-2.2.4/pyrogram/methods/chats/delete_supergroup.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/delete_user_history.py` & `PyroFork-2.2.4/pyrogram/methods/chats/delete_user_history.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/edit_forum_topic.py` & `PyroFork-2.2.4/pyrogram/methods/chats/edit_forum_topic.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/edit_general_topic.py` & `PyroFork-2.2.4/pyrogram/methods/chats/edit_general_topic.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/get_chat.py` & `PyroFork-2.2.4/pyrogram/methods/chats/get_chat.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/get_chat_event_log.py` & `PyroFork-2.2.4/pyrogram/methods/chats/get_chat_event_log.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/get_chat_member.py` & `PyroFork-2.2.4/pyrogram/methods/chats/get_chat_member.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/get_chat_members.py` & `PyroFork-2.2.4/pyrogram/methods/chats/get_chat_members.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/get_chat_members_count.py` & `PyroFork-2.2.4/pyrogram/methods/chats/get_chat_members_count.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/get_chat_online_count.py` & `PyroFork-2.2.4/pyrogram/methods/chats/get_chat_online_count.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/get_dialogs.py` & `PyroFork-2.2.4/pyrogram/methods/chats/get_dialogs.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/get_dialogs_count.py` & `PyroFork-2.2.4/pyrogram/methods/chats/get_dialogs_count.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/get_forum_topics.py` & `PyroFork-2.2.4/pyrogram/methods/chats/get_forum_topics.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/get_forum_topics_by_id.py` & `PyroFork-2.2.4/pyrogram/methods/chats/get_forum_topics_by_id.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/get_nearby_chats.py` & `PyroFork-2.2.4/pyrogram/methods/chats/get_nearby_chats.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/get_send_as_chats.py` & `PyroFork-2.2.4/pyrogram/methods/chats/get_send_as_chats.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/hide_general_topic.py` & `PyroFork-2.2.4/pyrogram/methods/chats/hide_general_topic.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/join_chat.py` & `PyroFork-2.2.4/pyrogram/methods/chats/join_chat.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/leave_chat.py` & `PyroFork-2.2.4/pyrogram/methods/chats/leave_chat.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/mark_chat_unread.py` & `PyroFork-2.2.4/pyrogram/methods/chats/mark_chat_unread.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/pin_chat_message.py` & `PyroFork-2.2.4/pyrogram/methods/chats/pin_chat_message.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/promote_chat_member.py` & `PyroFork-2.2.4/pyrogram/methods/chats/promote_chat_member.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/reopen_forum_topic.py` & `PyroFork-2.2.4/pyrogram/methods/chats/reopen_forum_topic.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/reopen_general_topic.py` & `PyroFork-2.2.4/pyrogram/methods/chats/reopen_general_topic.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/restrict_chat_member.py` & `PyroFork-2.2.4/pyrogram/methods/chats/restrict_chat_member.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/set_administrator_title.py` & `PyroFork-2.2.4/pyrogram/methods/chats/set_administrator_title.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/set_chat_description.py` & `PyroFork-2.2.4/pyrogram/methods/chats/set_chat_description.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/set_chat_permissions.py` & `PyroFork-2.2.4/pyrogram/methods/chats/set_chat_permissions.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/set_chat_photo.py` & `PyroFork-2.2.4/pyrogram/methods/chats/set_chat_photo.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/set_chat_protected_content.py` & `PyroFork-2.2.4/pyrogram/methods/chats/set_chat_protected_content.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/set_chat_title.py` & `PyroFork-2.2.4/pyrogram/methods/chats/set_chat_title.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/set_chat_username.py` & `PyroFork-2.2.4/pyrogram/methods/chats/set_chat_username.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/set_send_as_chat.py` & `PyroFork-2.2.4/pyrogram/methods/chats/set_send_as_chat.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/set_slow_mode.py` & `PyroFork-2.2.4/pyrogram/methods/chats/set_slow_mode.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/unarchive_chats.py` & `PyroFork-2.2.4/pyrogram/methods/chats/unarchive_chats.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/unban_chat_member.py` & `PyroFork-2.2.4/pyrogram/methods/chats/unban_chat_member.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/unhide_general_topic.py` & `PyroFork-2.2.4/pyrogram/methods/chats/unhide_general_topic.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/unpin_all_chat_messages.py` & `PyroFork-2.2.4/pyrogram/methods/chats/unpin_all_chat_messages.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/chats/unpin_chat_message.py` & `PyroFork-2.2.4/pyrogram/methods/chats/unpin_chat_message.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/contacts/__init__.py` & `PyroFork-2.2.4/pyrogram/methods/contacts/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/contacts/add_contact.py` & `PyroFork-2.2.4/pyrogram/methods/contacts/add_contact.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/contacts/delete_contacts.py` & `PyroFork-2.2.4/pyrogram/methods/contacts/delete_contacts.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/contacts/get_contacts.py` & `PyroFork-2.2.4/pyrogram/methods/contacts/get_contacts.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/contacts/get_contacts_count.py` & `PyroFork-2.2.4/pyrogram/methods/contacts/get_contacts_count.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/contacts/import_contacts.py` & `PyroFork-2.2.4/pyrogram/methods/contacts/import_contacts.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/decorators/__init__.py` & `PyroFork-2.2.4/pyrogram/methods/decorators/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/decorators/on_callback_query.py` & `PyroFork-2.2.4/pyrogram/methods/decorators/on_callback_query.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/decorators/on_chat_join_request.py` & `PyroFork-2.2.4/pyrogram/methods/decorators/on_chat_join_request.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/decorators/on_chat_member_updated.py` & `PyroFork-2.2.4/pyrogram/methods/decorators/on_chat_member_updated.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/decorators/on_chosen_inline_result.py` & `PyroFork-2.2.4/pyrogram/methods/decorators/on_chosen_inline_result.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/decorators/on_deleted_messages.py` & `PyroFork-2.2.4/pyrogram/methods/decorators/on_deleted_messages.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/decorators/on_disconnect.py` & `PyroFork-2.2.4/pyrogram/methods/decorators/on_disconnect.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/decorators/on_edited_message.py` & `PyroFork-2.2.4/pyrogram/methods/decorators/on_edited_message.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/decorators/on_inline_query.py` & `PyroFork-2.2.4/pyrogram/methods/decorators/on_inline_query.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/decorators/on_message.py` & `PyroFork-2.2.4/pyrogram/methods/decorators/on_message.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/decorators/on_poll.py` & `PyroFork-2.2.4/pyrogram/methods/decorators/on_poll.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/decorators/on_raw_update.py` & `PyroFork-2.2.4/pyrogram/methods/decorators/on_raw_update.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/decorators/on_user_status.py` & `PyroFork-2.2.4/pyrogram/methods/decorators/on_user_status.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/invite_links/__init__.py` & `PyroFork-2.2.4/pyrogram/methods/invite_links/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/invite_links/approve_all_chat_join_requests.py` & `PyroFork-2.2.4/pyrogram/methods/invite_links/approve_all_chat_join_requests.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/invite_links/approve_chat_join_request.py` & `PyroFork-2.2.4/pyrogram/methods/invite_links/approve_chat_join_request.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/invite_links/create_chat_invite_link.py` & `PyroFork-2.2.4/pyrogram/methods/invite_links/create_chat_invite_link.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/invite_links/decline_all_chat_join_requests.py` & `PyroFork-2.2.4/pyrogram/methods/invite_links/decline_all_chat_join_requests.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/invite_links/decline_chat_join_request.py` & `PyroFork-2.2.4/pyrogram/methods/invite_links/decline_chat_join_request.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/invite_links/delete_chat_admin_invite_links.py` & `PyroFork-2.2.4/pyrogram/methods/invite_links/delete_chat_admin_invite_links.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/invite_links/delete_chat_invite_link.py` & `PyroFork-2.2.4/pyrogram/methods/invite_links/delete_chat_invite_link.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/invite_links/edit_chat_invite_link.py` & `PyroFork-2.2.4/pyrogram/methods/invite_links/edit_chat_invite_link.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/invite_links/export_chat_invite_link.py` & `PyroFork-2.2.4/pyrogram/methods/invite_links/export_chat_invite_link.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/invite_links/get_chat_admin_invite_links.py` & `PyroFork-2.2.4/pyrogram/methods/invite_links/get_chat_admin_invite_links.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/invite_links/get_chat_admin_invite_links_count.py` & `PyroFork-2.2.4/pyrogram/methods/invite_links/get_chat_admin_invite_links_count.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/invite_links/get_chat_admins_with_invite_links.py` & `PyroFork-2.2.4/pyrogram/methods/invite_links/get_chat_admins_with_invite_links.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/invite_links/get_chat_invite_link.py` & `PyroFork-2.2.4/pyrogram/methods/invite_links/get_chat_invite_link.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/invite_links/get_chat_invite_link_joiners.py` & `PyroFork-2.2.4/pyrogram/methods/invite_links/get_chat_invite_link_joiners.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/invite_links/get_chat_invite_link_joiners_count.py` & `PyroFork-2.2.4/pyrogram/methods/invite_links/get_chat_invite_link_joiners_count.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/invite_links/get_chat_join_requests.py` & `PyroFork-2.2.4/pyrogram/methods/invite_links/get_chat_join_requests.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/invite_links/revoke_chat_invite_link.py` & `PyroFork-2.2.4/pyrogram/methods/invite_links/revoke_chat_invite_link.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/__init__.py` & `PyroFork-2.2.4/pyrogram/methods/messages/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/copy_media_group.py` & `PyroFork-2.2.4/pyrogram/methods/messages/copy_media_group.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/copy_message.py` & `PyroFork-2.2.4/pyrogram/methods/messages/copy_message.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/delete_messages.py` & `PyroFork-2.2.4/pyrogram/methods/messages/delete_messages.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/download_media.py` & `PyroFork-2.2.4/pyrogram/methods/messages/download_media.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/edit_inline_caption.py` & `PyroFork-2.2.4/pyrogram/methods/messages/edit_inline_caption.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/edit_inline_media.py` & `PyroFork-2.2.4/pyrogram/methods/messages/edit_inline_media.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/edit_inline_reply_markup.py` & `PyroFork-2.2.4/pyrogram/methods/messages/edit_inline_reply_markup.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/edit_inline_text.py` & `PyroFork-2.2.4/pyrogram/methods/messages/edit_inline_text.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/edit_message_caption.py` & `PyroFork-2.2.4/pyrogram/methods/messages/edit_message_caption.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/edit_message_media.py` & `PyroFork-2.2.4/pyrogram/methods/messages/edit_message_media.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/edit_message_reply_markup.py` & `PyroFork-2.2.4/pyrogram/methods/messages/edit_message_reply_markup.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/edit_message_text.py` & `PyroFork-2.2.4/pyrogram/methods/messages/edit_message_text.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/forward_messages.py` & `PyroFork-2.2.4/pyrogram/methods/messages/forward_messages.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/get_chat_history.py` & `PyroFork-2.2.4/pyrogram/methods/messages/get_chat_history.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/get_chat_history_count.py` & `PyroFork-2.2.4/pyrogram/methods/messages/get_chat_history_count.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/get_custom_emoji_stickers.py` & `PyroFork-2.2.4/pyrogram/methods/messages/get_custom_emoji_stickers.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/get_discussion_message.py` & `PyroFork-2.2.4/pyrogram/methods/messages/get_discussion_message.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/get_discussion_replies.py` & `PyroFork-2.2.4/pyrogram/methods/messages/get_discussion_replies.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/get_discussion_replies_count.py` & `PyroFork-2.2.4/pyrogram/methods/messages/get_discussion_replies_count.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/get_media_group.py` & `PyroFork-2.2.4/pyrogram/methods/messages/get_media_group.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/get_messages.py` & `PyroFork-2.2.4/pyrogram/methods/messages/get_messages.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/inline_session.py` & `PyroFork-2.2.4/pyrogram/methods/messages/inline_session.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/read_chat_history.py` & `PyroFork-2.2.4/pyrogram/methods/messages/read_chat_history.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/retract_vote.py` & `PyroFork-2.2.4/pyrogram/methods/messages/retract_vote.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/search_global.py` & `PyroFork-2.2.4/pyrogram/methods/messages/search_global.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/search_global_count.py` & `PyroFork-2.2.4/pyrogram/methods/messages/search_global_count.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/search_messages.py` & `PyroFork-2.2.4/pyrogram/methods/messages/search_messages.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/search_messages_count.py` & `PyroFork-2.2.4/pyrogram/methods/messages/search_messages_count.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/send_animation.py` & `PyroFork-2.2.4/pyrogram/methods/messages/send_animation.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/send_audio.py` & `PyroFork-2.2.4/pyrogram/methods/messages/send_audio.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/send_cached_media.py` & `PyroFork-2.2.4/pyrogram/methods/messages/send_cached_media.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/send_chat_action.py` & `PyroFork-2.2.4/pyrogram/methods/messages/send_chat_action.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/send_contact.py` & `PyroFork-2.2.4/pyrogram/methods/messages/send_contact.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/send_dice.py` & `PyroFork-2.2.4/pyrogram/methods/messages/send_dice.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/send_document.py` & `PyroFork-2.2.4/pyrogram/methods/messages/send_document.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/send_location.py` & `PyroFork-2.2.4/pyrogram/methods/messages/send_location.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/send_media_group.py` & `PyroFork-2.2.4/pyrogram/methods/messages/send_media_group.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/send_message.py` & `PyroFork-2.2.4/pyrogram/methods/messages/send_message.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/send_photo.py` & `PyroFork-2.2.4/pyrogram/methods/messages/send_photo.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/send_poll.py` & `PyroFork-2.2.4/pyrogram/methods/messages/send_poll.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/send_reaction.py` & `PyroFork-2.2.4/pyrogram/methods/messages/send_reaction.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/send_sticker.py` & `PyroFork-2.2.4/pyrogram/methods/messages/send_sticker.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/send_venue.py` & `PyroFork-2.2.4/pyrogram/methods/messages/send_venue.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/send_video.py` & `PyroFork-2.2.4/pyrogram/methods/messages/send_video.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/send_video_note.py` & `PyroFork-2.2.4/pyrogram/methods/messages/send_video_note.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/send_voice.py` & `PyroFork-2.2.4/pyrogram/methods/messages/send_voice.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/stop_poll.py` & `PyroFork-2.2.4/pyrogram/methods/messages/stop_poll.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/stream_media.py` & `PyroFork-2.2.4/pyrogram/methods/messages/stream_media.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/messages/vote_poll.py` & `PyroFork-2.2.4/pyrogram/methods/messages/vote_poll.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/password/__init__.py` & `PyroFork-2.2.4/pyrogram/methods/password/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/password/change_cloud_password.py` & `PyroFork-2.2.4/pyrogram/methods/password/change_cloud_password.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/password/enable_cloud_password.py` & `PyroFork-2.2.4/pyrogram/methods/password/enable_cloud_password.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/password/remove_cloud_password.py` & `PyroFork-2.2.4/pyrogram/methods/password/remove_cloud_password.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/stickers/__init__.py` & `PyroFork-2.2.4/pyrogram/methods/stickers/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/stickers/add_sticker_to_set.py` & `PyroFork-2.2.4/pyrogram/methods/stickers/add_sticker_to_set.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/stickers/create_sticker_set.py` & `PyroFork-2.2.4/pyrogram/methods/stickers/create_sticker_set.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/stickers/get_sticker_set.py` & `PyroFork-2.2.4/pyrogram/methods/stickers/get_sticker_set.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/users/__init__.py` & `PyroFork-2.2.4/pyrogram/methods/users/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/users/block_user.py` & `PyroFork-2.2.4/pyrogram/methods/users/block_user.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/users/delete_profile_photos.py` & `PyroFork-2.2.4/pyrogram/methods/users/delete_profile_photos.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/users/get_chat_photos.py` & `PyroFork-2.2.4/pyrogram/methods/users/get_chat_photos.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/users/get_chat_photos_count.py` & `PyroFork-2.2.4/pyrogram/methods/users/get_chat_photos_count.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/users/get_common_chats.py` & `PyroFork-2.2.4/pyrogram/methods/users/get_common_chats.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/users/get_default_emoji_statuses.py` & `PyroFork-2.2.4/pyrogram/methods/users/get_default_emoji_statuses.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/users/get_me.py` & `PyroFork-2.2.4/pyrogram/methods/users/get_me.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/users/get_users.py` & `PyroFork-2.2.4/pyrogram/methods/users/get_users.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/users/set_emoji_status.py` & `PyroFork-2.2.4/pyrogram/methods/users/set_emoji_status.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/users/set_profile_photo.py` & `PyroFork-2.2.4/pyrogram/methods/users/set_profile_photo.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/users/set_username.py` & `PyroFork-2.2.4/pyrogram/methods/users/set_username.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/users/unblock_user.py` & `PyroFork-2.2.4/pyrogram/methods/users/unblock_user.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/users/update_profile.py` & `PyroFork-2.2.4/pyrogram/methods/users/update_profile.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/utilities/__init__.py` & `PyroFork-2.2.4/pyrogram/methods/utilities/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/utilities/add_handler.py` & `PyroFork-2.2.4/pyrogram/methods/utilities/add_handler.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/utilities/compose.py` & `PyroFork-2.2.4/pyrogram/methods/utilities/compose.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/utilities/export_session_string.py` & `PyroFork-2.2.4/pyrogram/methods/utilities/export_session_string.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/utilities/idle.py` & `PyroFork-2.2.4/pyrogram/methods/utilities/idle.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/utilities/remove_handler.py` & `PyroFork-2.2.4/pyrogram/methods/utilities/remove_handler.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/utilities/restart.py` & `PyroFork-2.2.4/pyrogram/methods/utilities/restart.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/utilities/run.py` & `PyroFork-2.2.4/pyrogram/methods/utilities/run.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/utilities/run_sync.py` & `PyroFork-2.2.4/pyrogram/methods/utilities/run_sync.py`
...
### Comparing `PyroFork-2.2.3/pyrogram/methods/utilities/start.py` & `PyroFork-2.2.4/pyrogram/methods/utilities/start.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/utilities/stop.py` & `PyroFork-2.2.4/pyrogram/methods/utilities/stop.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/methods/utilities/stop_transmission.py` & `PyroFork-2.2.4/pyrogram/methods/utilities/stop_transmission.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/mime_types.py` & `PyroFork-2.2.4/pyrogram/mime_types.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/parser/__init__.py` & `PyroFork-2.2.4/pyrogram/parser/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/parser/html.py` & `PyroFork-2.2.4/pyrogram/parser/html.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/parser/markdown.py` & `PyroFork-2.2.4/pyrogram/parser/markdown.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/parser/parser.py` & `PyroFork-2.2.4/pyrogram/parser/parser.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/parser/utils.py` & `PyroFork-2.2.4/pyrogram/parser/utils.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/raw/__init__.py` & `PyroFork-2.2.4/pyrogram/raw/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/raw/core/__init__.py` & `PyroFork-2.2.4/pyrogram/raw/core/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/raw/core/future_salt.py` & `PyroFork-2.2.4/pyrogram/raw/core/future_salt.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/raw/core/future_salts.py` & `PyroFork-2.2.4/pyrogram/raw/core/future_salts.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/raw/core/gzip_packed.py` & `PyroFork-2.2.4/pyrogram/raw/core/gzip_packed.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/raw/core/list.py` & `PyroFork-2.2.4/pyrogram/raw/core/list.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/raw/core/message.py` & `PyroFork-2.2.4/pyrogram/raw/core/message.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/raw/core/msg_container.py` & `PyroFork-2.2.4/pyrogram/raw/core/msg_container.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/raw/core/primitives/__init__.py` & `PyroFork-2.2.4/pyrogram/raw/core/primitives/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/raw/core/primitives/bool.py` & `PyroFork-2.2.4/pyrogram/raw/core/primitives/bool.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/raw/core/primitives/bytes.py` & `PyroFork-2.2.4/pyrogram/raw/core/primitives/bytes.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/raw/core/primitives/double.py` & `PyroFork-2.2.4/pyrogram/raw/core/primitives/double.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/raw/core/primitives/int.py` & `PyroFork-2.2.4/pyrogram/raw/core/primitives/int.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/raw/core/primitives/string.py` & `PyroFork-2.2.4/pyrogram/raw/core/primitives/string.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/raw/core/primitives/vector.py` & `PyroFork-2.2.4/pyrogram/raw/core/primitives/vector.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/raw/core/tl_object.py` & `PyroFork-2.2.4/pyrogram/raw/core/tl_object.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/session/__init__.py` & `PyroFork-2.2.4/pyrogram/session/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/session/auth.py` & `PyroFork-2.2.4/pyrogram/session/auth.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/session/internals/__init__.py` & `PyroFork-2.2.4/pyrogram/session/internals/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/session/internals/data_center.py` & `PyroFork-2.2.4/pyrogram/session/internals/data_center.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/session/internals/msg_factory.py` & `PyroFork-2.2.4/pyrogram/session/internals/msg_factory.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/session/internals/msg_id.py` & `PyroFork-2.2.4/pyrogram/session/internals/msg_id.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/session/internals/seq_no.py` & `PyroFork-2.2.4/pyrogram/session/internals/seq_no.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/session/session.py` & `PyroFork-2.2.4/pyrogram/session/session.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/storage/__init__.py` & `PyroFork-2.2.4/pyrogram/storage/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/storage/dummy_client.py` & `PyroFork-2.2.4/pyrogram/storage/dummy_client.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/storage/file_storage.py` & `PyroFork-2.2.4/pyrogram/storage/file_storage.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/storage/memory_storage.py` & `PyroFork-2.2.4/pyrogram/storage/memory_storage.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/storage/mongo_storage.py` & `PyroFork-2.2.4/pyrogram/storage/mongo_storage.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/storage/sqlite/sqlite.py` & `PyroFork-2.2.4/pyrogram/storage/sqlite/sqlite.py`
...
### Comparing `PyroFork-2.2.3/pyrogram/storage/sqlite_storage.py` & `PyroFork-2.2.4/pyrogram/storage/sqlite_storage.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/storage/storage.py` & `PyroFork-2.2.4/pyrogram/storage/storage.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/sync.py` & `PyroFork-2.2.4/pyrogram/sync.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/__init__.py` & `PyroFork-2.2.4/pyrogram/types/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/authorization/__init__.py` & `PyroFork-2.2.4/pyrogram/types/authorization/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/authorization/sent_code.py` & `PyroFork-2.2.4/pyrogram/types/authorization/sent_code.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/authorization/terms_of_service.py` & `PyroFork-2.2.4/pyrogram/types/authorization/terms_of_service.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/bots_and_keyboards/__init__.py` & `PyroFork-2.2.4/pyrogram/types/bots_and_keyboards/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/bots_and_keyboards/bot_command.py` & `PyroFork-2.2.4/pyrogram/types/bots_and_keyboards/bot_command.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/bots_and_keyboards/bot_command_scope.py` & `PyroFork-2.2.4/pyrogram/types/bots_and_keyboards/bot_command_scope.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/bots_and_keyboards/bot_command_scope_all_chat_administrators.py` & `PyroFork-2.2.4/pyrogram/types/bots_and_keyboards/bot_command_scope_all_chat_administrators.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/bots_and_keyboards/bot_command_scope_all_group_chats.py` & `PyroFork-2.2.4/pyrogram/types/bots_and_keyboards/bot_command_scope_all_group_chats.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/bots_and_keyboards/bot_command_scope_all_private_chats.py` & `PyroFork-2.2.4/pyrogram/types/bots_and_keyboards/bot_command_scope_all_private_chats.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/bots_and_keyboards/bot_command_scope_chat.py` & `PyroFork-2.2.4/pyrogram/types/bots_and_keyboards/bot_command_scope_chat.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/bots_and_keyboards/bot_command_scope_chat_administrators.py` & `PyroFork-2.2.4/pyrogram/types/bots_and_keyboards/bot_command_scope_chat_administrators.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/bots_and_keyboards/bot_command_scope_chat_member.py` & `PyroFork-2.2.4/pyrogram/types/bots_and_keyboards/bot_command_scope_chat_member.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/bots_and_keyboards/bot_command_scope_default.py` & `PyroFork-2.2.4/pyrogram/types/bots_and_keyboards/bot_command_scope_default.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/bots_and_keyboards/callback_game.py` & `PyroFork-2.2.4/pyrogram/types/bots_and_keyboards/callback_game.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/bots_and_keyboards/callback_query.py` & `PyroFork-2.2.4/pyrogram/types/bots_and_keyboards/callback_query.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/bots_and_keyboards/force_reply.py` & `PyroFork-2.2.4/pyrogram/types/bots_and_keyboards/force_reply.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/bots_and_keyboards/game_high_score.py` & `PyroFork-2.2.4/pyrogram/types/bots_and_keyboards/game_high_score.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/bots_and_keyboards/inline_keyboard_button.py` & `PyroFork-2.2.4/pyrogram/types/bots_and_keyboards/inline_keyboard_button.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/bots_and_keyboards/inline_keyboard_markup.py` & `PyroFork-2.2.4/pyrogram/types/bots_and_keyboards/inline_keyboard_markup.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/bots_and_keyboards/keyboard_button.py` & `PyroFork-2.2.4/pyrogram/types/bots_and_keyboards/keyboard_button.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/bots_and_keyboards/login_url.py` & `PyroFork-2.2.4/pyrogram/types/bots_and_keyboards/login_url.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/bots_and_keyboards/menu_button.py` & `PyroFork-2.2.4/pyrogram/types/bots_and_keyboards/menu_button.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/bots_and_keyboards/menu_button_commands.py` & `PyroFork-2.2.4/pyrogram/types/bots_and_keyboards/menu_button_commands.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/bots_and_keyboards/menu_button_default.py` & `PyroFork-2.2.4/pyrogram/types/bots_and_keyboards/menu_button_default.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/bots_and_keyboards/menu_button_web_app.py` & `PyroFork-2.2.4/pyrogram/types/bots_and_keyboards/menu_button_web_app.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/bots_and_keyboards/reply_keyboard_markup.py` & `PyroFork-2.2.4/pyrogram/types/bots_and_keyboards/reply_keyboard_markup.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/bots_and_keyboards/reply_keyboard_remove.py` & `PyroFork-2.2.4/pyrogram/types/bots_and_keyboards/reply_keyboard_remove.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/bots_and_keyboards/sent_web_app_message.py` & `PyroFork-2.2.4/pyrogram/types/bots_and_keyboards/sent_web_app_message.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/bots_and_keyboards/web_app_info.py` & `PyroFork-2.2.4/pyrogram/types/bots_and_keyboards/web_app_info.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/inline_mode/__init__.py` & `PyroFork-2.2.4/pyrogram/types/inline_mode/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/inline_mode/chosen_inline_result.py` & `PyroFork-2.2.4/pyrogram/types/inline_mode/chosen_inline_result.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/inline_mode/inline_query.py` & `PyroFork-2.2.4/pyrogram/types/inline_mode/inline_query.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/inline_mode/inline_query_result.py` & `PyroFork-2.2.4/pyrogram/types/inline_mode/inline_query_result.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/inline_mode/inline_query_result_animation.py` & `PyroFork-2.2.4/pyrogram/types/inline_mode/inline_query_result_animation.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/inline_mode/inline_query_result_article.py` & `PyroFork-2.2.4/pyrogram/types/inline_mode/inline_query_result_article.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/inline_mode/inline_query_result_audio.py` & `PyroFork-2.2.4/pyrogram/types/inline_mode/inline_query_result_audio.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/inline_mode/inline_query_result_cached_animation.py` & `PyroFork-2.2.4/pyrogram/types/inline_mode/inline_query_result_cached_animation.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/inline_mode/inline_query_result_cached_audio.py` & `PyroFork-2.2.4/pyrogram/types/inline_mode/inline_query_result_cached_audio.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/inline_mode/inline_query_result_cached_document.py` & `PyroFork-2.2.4/pyrogram/types/inline_mode/inline_query_result_cached_document.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/inline_mode/inline_query_result_cached_photo.py` & `PyroFork-2.2.4/pyrogram/types/inline_mode/inline_query_result_cached_photo.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/inline_mode/inline_query_result_cached_sticker.py` & `PyroFork-2.2.4/pyrogram/types/inline_mode/inline_query_result_cached_sticker.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/inline_mode/inline_query_result_cached_video.py` & `PyroFork-2.2.4/pyrogram/types/inline_mode/inline_query_result_cached_video.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/inline_mode/inline_query_result_cached_voice.py` & `PyroFork-2.2.4/pyrogram/types/inline_mode/inline_query_result_cached_voice.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/inline_mode/inline_query_result_contact.py` & `PyroFork-2.2.4/pyrogram/types/inline_mode/inline_query_result_contact.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/inline_mode/inline_query_result_document.py` & `PyroFork-2.2.4/pyrogram/types/inline_mode/inline_query_result_document.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/inline_mode/inline_query_result_location.py` & `PyroFork-2.2.4/pyrogram/types/inline_mode/inline_query_result_location.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/inline_mode/inline_query_result_photo.py` & `PyroFork-2.2.4/pyrogram/types/inline_mode/inline_query_result_photo.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/inline_mode/inline_query_result_venue.py` & `PyroFork-2.2.4/pyrogram/types/inline_mode/inline_query_result_venue.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/inline_mode/inline_query_result_video.py` & `PyroFork-2.2.4/pyrogram/types/inline_mode/inline_query_result_video.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/inline_mode/inline_query_result_voice.py` & `PyroFork-2.2.4/pyrogram/types/inline_mode/inline_query_result_voice.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/input_media/__init__.py` & `PyroFork-2.2.4/pyrogram/types/input_media/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/input_media/input_media.py` & `PyroFork-2.2.4/pyrogram/types/input_media/input_media.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/input_media/input_media_animation.py` & `PyroFork-2.2.4/pyrogram/types/input_media/input_media_animation.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/input_media/input_media_audio.py` & `PyroFork-2.2.4/pyrogram/types/input_media/input_media_audio.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/input_media/input_media_document.py` & `PyroFork-2.2.4/pyrogram/types/input_media/input_media_document.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/input_media/input_media_photo.py` & `PyroFork-2.2.4/pyrogram/types/input_media/input_media_photo.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/input_media/input_media_video.py` & `PyroFork-2.2.4/pyrogram/types/input_media/input_media_video.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/input_media/input_phone_contact.py` & `PyroFork-2.2.4/pyrogram/types/input_media/input_phone_contact.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/input_message_content/__init__.py` & `PyroFork-2.2.4/pyrogram/types/input_message_content/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/input_message_content/input_message_content.py` & `PyroFork-2.2.4/pyrogram/types/input_message_content/input_message_content.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/input_message_content/input_text_message_content.py` & `PyroFork-2.2.4/pyrogram/types/input_message_content/input_text_message_content.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/list.py` & `PyroFork-2.2.4/pyrogram/types/list.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/messages_and_media/__init__.py` & `PyroFork-2.2.4/pyrogram/types/messages_and_media/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/messages_and_media/animation.py` & `PyroFork-2.2.4/pyrogram/types/messages_and_media/animation.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/messages_and_media/audio.py` & `PyroFork-2.2.4/pyrogram/types/messages_and_media/audio.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/messages_and_media/contact.py` & `PyroFork-2.2.4/pyrogram/types/messages_and_media/contact.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/messages_and_media/dice.py` & `PyroFork-2.2.4/pyrogram/types/messages_and_media/dice.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/messages_and_media/document.py` & `PyroFork-2.2.4/pyrogram/types/messages_and_media/document.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/messages_and_media/game.py` & `PyroFork-2.2.4/pyrogram/types/messages_and_media/game.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/messages_and_media/location.py` & `PyroFork-2.2.4/pyrogram/types/messages_and_media/location.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/messages_and_media/message.py` & `PyroFork-2.2.4/pyrogram/types/messages_and_media/message.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/messages_and_media/message_entity.py` & `PyroFork-2.2.4/pyrogram/types/messages_and_media/message_entity.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/messages_and_media/message_reactions.py` & `PyroFork-2.2.4/pyrogram/types/messages_and_media/message_reactions.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/messages_and_media/photo.py` & `PyroFork-2.2.4/pyrogram/types/messages_and_media/photo.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/messages_and_media/poll.py` & `PyroFork-2.2.4/pyrogram/types/messages_and_media/poll.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/messages_and_media/poll_option.py` & `PyroFork-2.2.4/pyrogram/types/messages_and_media/poll_option.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/messages_and_media/reaction.py` & `PyroFork-2.2.4/pyrogram/types/messages_and_media/reaction.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/messages_and_media/sticker.py` & `PyroFork-2.2.4/pyrogram/types/messages_and_media/sticker.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/messages_and_media/stickerset.py` & `PyroFork-2.2.4/pyrogram/types/messages_and_media/stickerset.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/messages_and_media/stripped_thumbnail.py` & `PyroFork-2.2.4/pyrogram/types/messages_and_media/stripped_thumbnail.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/messages_and_media/thumbnail.py` & `PyroFork-2.2.4/pyrogram/types/messages_and_media/thumbnail.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/messages_and_media/venue.py` & `PyroFork-2.2.4/pyrogram/types/messages_and_media/venue.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/messages_and_media/video.py` & `PyroFork-2.2.4/pyrogram/types/messages_and_media/video.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/messages_and_media/video_note.py` & `PyroFork-2.2.4/pyrogram/types/messages_and_media/video_note.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/messages_and_media/voice.py` & `PyroFork-2.2.4/pyrogram/types/messages_and_media/voice.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/messages_and_media/web_app_data.py` & `PyroFork-2.2.4/pyrogram/types/messages_and_media/web_app_data.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/messages_and_media/web_page.py` & `PyroFork-2.2.4/pyrogram/types/messages_and_media/web_page.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/object.py` & `PyroFork-2.2.4/pyrogram/types/object.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/update.py` & `PyroFork-2.2.4/pyrogram/types/update.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/user_and_chats/__init__.py` & `PyroFork-2.2.4/pyrogram/types/user_and_chats/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/user_and_chats/chat.py` & `PyroFork-2.2.4/pyrogram/types/user_and_chats/chat.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/user_and_chats/chat_admin_with_invite_links.py` & `PyroFork-2.2.4/pyrogram/types/user_and_chats/chat_admin_with_invite_links.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/user_and_chats/chat_event.py` & `PyroFork-2.2.4/pyrogram/types/user_and_chats/chat_event.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/user_and_chats/chat_event_filter.py` & `PyroFork-2.2.4/pyrogram/types/user_and_chats/chat_event_filter.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/user_and_chats/chat_invite_link.py` & `PyroFork-2.2.4/pyrogram/types/user_and_chats/chat_invite_link.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/user_and_chats/chat_join_request.py` & `PyroFork-2.2.4/pyrogram/types/user_and_chats/chat_join_request.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/user_and_chats/chat_joined_by_request.py` & `PyroFork-2.2.4/pyrogram/types/user_and_chats/chat_joined_by_request.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/user_and_chats/chat_joiner.py` & `PyroFork-2.2.4/pyrogram/types/user_and_chats/chat_joiner.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/user_and_chats/chat_member.py` & `PyroFork-2.2.4/pyrogram/types/user_and_chats/chat_member.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/user_and_chats/chat_member_updated.py` & `PyroFork-2.2.4/pyrogram/types/user_and_chats/chat_member_updated.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/user_and_chats/chat_permissions.py` & `PyroFork-2.2.4/pyrogram/types/user_and_chats/chat_permissions.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/user_and_chats/chat_photo.py` & `PyroFork-2.2.4/pyrogram/types/user_and_chats/chat_photo.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/user_and_chats/chat_preview.py` & `PyroFork-2.2.4/pyrogram/types/user_and_chats/chat_preview.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/user_and_chats/chat_privileges.py` & `PyroFork-2.2.4/pyrogram/types/user_and_chats/chat_privileges.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/user_and_chats/chat_reactions.py` & `PyroFork-2.2.4/pyrogram/types/user_and_chats/chat_reactions.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/user_and_chats/dialog.py` & `PyroFork-2.2.4/pyrogram/types/user_and_chats/dialog.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/user_and_chats/emoji_status.py` & `PyroFork-2.2.4/pyrogram/types/user_and_chats/emoji_status.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/user_and_chats/forum_topic.py` & `PyroFork-2.2.4/pyrogram/types/user_and_chats/forum_topic.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/user_and_chats/forum_topic_closed.py` & `PyroFork-2.2.4/pyrogram/types/user_and_chats/forum_topic_closed.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/user_and_chats/forum_topic_created.py` & `PyroFork-2.2.4/pyrogram/types/user_and_chats/forum_topic_created.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/user_and_chats/forum_topic_edited.py` & `PyroFork-2.2.4/pyrogram/types/user_and_chats/forum_topic_edited.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/user_and_chats/forum_topic_reopened.py` & `PyroFork-2.2.4/pyrogram/types/user_and_chats/forum_topic_reopened.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/user_and_chats/general_forum_topic_hidden.py` & `PyroFork-2.2.4/pyrogram/types/user_and_chats/general_forum_topic_hidden.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/user_and_chats/general_forum_topic_unhidden.py` & `PyroFork-2.2.4/pyrogram/types/user_and_chats/general_forum_topic_unhidden.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/user_and_chats/invite_link_importer.py` & `PyroFork-2.2.4/pyrogram/types/user_and_chats/invite_link_importer.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/user_and_chats/peer_channel.py` & `PyroFork-2.2.4/pyrogram/types/user_and_chats/peer_channel.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/user_and_chats/peer_user.py` & `PyroFork-2.2.4/pyrogram/types/user_and_chats/peer_user.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/user_and_chats/restriction.py` & `PyroFork-2.2.4/pyrogram/types/user_and_chats/restriction.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/user_and_chats/user.py` & `PyroFork-2.2.4/pyrogram/types/user_and_chats/user.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/user_and_chats/username.py` & `PyroFork-2.2.4/pyrogram/types/user_and_chats/username.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/user_and_chats/video_chat_ended.py` & `PyroFork-2.2.4/pyrogram/types/user_and_chats/video_chat_ended.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/user_and_chats/video_chat_members_invited.py` & `PyroFork-2.2.4/pyrogram/types/user_and_chats/video_chat_members_invited.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/user_and_chats/video_chat_scheduled.py` & `PyroFork-2.2.4/pyrogram/types/user_and_chats/video_chat_scheduled.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/types/user_and_chats/video_chat_started.py` & `PyroFork-2.2.4/pyrogram/types/user_and_chats/video_chat_started.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/pyrogram/utils.py` & `PyroFork-2.2.4/pyrogram/utils.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/setup.py` & `PyroFork-2.2.4/setup.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/tests/__init__.py` & `PyroFork-2.2.4/tests/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/tests/filters/__init__.py` & `PyroFork-2.2.4/tests/filters/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/tests/filters/test_command.py` & `PyroFork-2.2.4/tests/filters/test_command.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/tests/parser/__init__.py` & `PyroFork-2.2.4/tests/parser/__init__.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/tests/parser/test_html.py` & `PyroFork-2.2.4/tests/parser/test_html.py`

 * *Files identical despite different names*

### Comparing `PyroFork-2.2.3/tests/test_file_id.py` & `PyroFork-2.2.4/tests/test_file_id.py`
