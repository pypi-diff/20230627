# Comparing `tmp/global_chem-1.8.1.tar.gz` & `tmp/global_chem-1.8.1.1.tar.gz`
...
### Comparing `global_chem-1.8.1/global_chem/medicinal_chemistry/cannabinoids/non_cannabinoids_phenols.py` & `global_chem-1.8.1.1/global_chem/medicinal_chemistry/cannabinoids/non_cannabinoids_phenols.py`
...
### Comparing `global_chem-1.8.1/global_chem/medicinal_chemistry/cannabinoids/sugars.py` & `global_chem-1.8.1.1/global_chem/medicinal_chemistry/cannabinoids/sugars.py`

 * *Files identical despite different names*

### Comparing `global_chem-1.8.1/global_chem/medicinal_chemistry/cannabinoids/terpenes.py` & `global_chem-1.8.1.1/global_chem/medicinal_chemistry/cannabinoids/terpenes.py`

 * *Files identical despite different names*

### Comparing `global_chem-1.8.1/global_chem/medicinal_chemistry/chinese/how_to_live_longer.py` & `global_chem-1.8.1.1/global_chem/medicinal_chemistry/chinese/how_to_live_longer.py`

 * *Files identical despite different names*

### Comparing `global_chem-1.8.1/global_chem/medicinal_chemistry/rings/iupac_blue_book_rings.py` & `global_chem-1.8.1.1/global_chem/medicinal_chemistry/rings/iupac_blue_book_rings.py`

 * *Files identical despite different names*

### Comparing `global_chem-1.8.1/global_chem/medicinal_chemistry/rings/phase_2_hetereocyclic_rings.py` & `global_chem-1.8.1.1/global_chem/medicinal_chemistry/rings/phase_2_hetereocyclic_rings.py`

 * *Files identical despite different names*

### Comparing `global_chem-1.8.1/global_chem/medicinal_chemistry/rings/rings_in_drugs.py` & `global_chem-1.8.1.1/global_chem/medicinal_chemistry/rings/rings_in_drugs.py`

 * *Files identical despite different names*

### Comparing `global_chem-1.8.1/global_chem/medicinal_chemistry/scaffolds/common_r_group_replacements.py` & `global_chem-1.8.1.1/global_chem/medicinal_chemistry/scaffolds/common_r_group_replacements.py`

 * *Files identical despite different names*

### Comparing `global_chem-1.8.1/global_chem/medicinal_chemistry/scaffolds/iupac_blue_book.py` & `global_chem-1.8.1.1/global_chem/medicinal_chemistry/scaffolds/iupac_blue_book.py`

 * *Files identical despite different names*

### Comparing `global_chem-1.8.1/global_chem/medicinal_chemistry/scaffolds/privileged_scaffolds.py` & `global_chem-1.8.1.1/global_chem/medicinal_chemistry/scaffolds/privileged_scaffolds.py`

 * *Files identical despite different names*

### Comparing `global_chem-1.8.1/global_chem/medicinal_chemistry/warheads/common_warheads_covalent_inhibitors.py` & `global_chem-1.8.1.1/global_chem/medicinal_chemistry/warheads/common_warheads_covalent_inhibitors.py`

 * *Files identical despite different names*

### Comparing `global_chem-1.8.1/global_chem/medicinal_chemistry/warheads/electrophilic_warheads_for_kinases.py` & `global_chem-1.8.1.1/global_chem/medicinal_chemistry/warheads/electrophilic_warheads_for_kinases.py`

 * *Files identical despite different names*

### Comparing `global_chem-1.8.1/global_chem/miscellaneous/amino_acids.py` & `global_chem-1.8.1.1/global_chem/miscellaneous/amino_acids.py`

 * *Files identical despite different names*

### Comparing `global_chem-1.8.1/global_chem/miscellaneous/open_smiles.py` & `global_chem-1.8.1.1/global_chem/miscellaneous/open_smiles.py`

 * *Files identical despite different names*

### Comparing `global_chem-1.8.1/global_chem/miscellaneous/vitamins.py` & `global_chem-1.8.1.1/global_chem/miscellaneous/vitamins.py`

 * *Files identical despite different names*

### Comparing `global_chem-1.8.1/global_chem/narcotics/pihkal.py` & `global_chem-1.8.1.1/global_chem/narcotics/pihkal.py`

 * *Files identical despite different names*

### Comparing `global_chem-1.8.1/global_chem/narcotics/schedule_five.py` & `global_chem-1.8.1.1/global_chem/narcotics/schedule_five.py`

 * *Files identical despite different names*

### Comparing `global_chem-1.8.1/global_chem/narcotics/schedule_four.py` & `global_chem-1.8.1.1/global_chem/narcotics/schedule_four.py`

 * *Files identical despite different names*

### Comparing `global_chem-1.8.1/global_chem/narcotics/schedule_one.py` & `global_chem-1.8.1.1/global_chem/narcotics/schedule_one.py`

 * *Files identical despite different names*

### Comparing `global_chem-1.8.1/global_chem/narcotics/schedule_three.py` & `global_chem-1.8.1.1/global_chem/narcotics/schedule_three.py`

 * *Files identical despite different names*

### Comparing `global_chem-1.8.1/global_chem/narcotics/schedule_two.py` & `global_chem-1.8.1.1/global_chem/narcotics/schedule_two.py`

 * *Files identical despite different names*

### Comparing `global_chem-1.8.1/global_chem/organic_synthesis/bidendate_phosphine_ligands/nickel_ligands.py` & `global_chem-1.8.1.1/global_chem/organic_synthesis/bidendate_phosphine_ligands/nickel_ligands.py`

 * *Files identical despite different names*

### Comparing `global_chem-1.8.1/global_chem/organic_synthesis/protecting_groups/amino_acid_protecting_groups.py` & `global_chem-1.8.1.1/global_chem/organic_synthesis/protecting_groups/amino_acid_protecting_groups.py`

 * *Files identical despite different names*

### Comparing `global_chem-1.8.1/global_chem/organic_synthesis/solvents/common_organic_solvents.py` & `global_chem-1.8.1.1/global_chem/organic_synthesis/solvents/common_organic_solvents.py`

 * *Files identical despite different names*

### Comparing `global_chem-1.8.1/global_chem/peptides/lanthipeptides.py` & `global_chem-1.8.1.1/global_chem/peptides/lanthipeptides.py`

 * *Files identical despite different names*

### Comparing `global_chem-1.8.1/global_chem/proteins/kinases/braf/braf_inhibitors.py` & `global_chem-1.8.1.1/global_chem/proteins/kinases/braf/braf_inhibitors.py`

 * *Files identical despite different names*

### Comparing `global_chem-1.8.1/global_chem/proteins/kinases/scaffolds/privileged_kinase_inhibitors.py` & `global_chem-1.8.1.1/global_chem/proteins/kinases/scaffolds/privileged_kinase_inhibitors.py`

 * *Files identical despite different names*

### Comparing `global_chem-1.8.1/global_chem/sex/contraceptives/oral_contraceptives.py` & `global_chem-1.8.1.1/global_chem/sex/contraceptives/oral_contraceptives.py`

 * *Files identical despite different names*

### Comparing `global_chem-1.8.1/global_chem/sex/exsens/exsens_products.py` & `global_chem-1.8.1.1/global_chem/sex/exsens/exsens_products.py`

 * *Files identical despite different names*

### Comparing `global_chem-1.8.1/global_chem/sex/exsens/lube.py` & `global_chem-1.8.1.1/global_chem/sex/exsens/lube.py`

 * *Files identical despite different names*

### Comparing `global_chem-1.8.1/global_chem/sex/tainted_sexual_enhancements/tainted_sexual_enhancements.py` & `global_chem-1.8.1.1/global_chem/sex/tainted_sexual_enhancements/tainted_sexual_enhancements.py`

 * *Files identical despite different names*

### Comparing `global_chem-1.8.1/global_chem/skin/transdermal_and_dermal_delivery/surfactants.py` & `global_chem-1.8.1.1/global_chem/skin/transdermal_and_dermal_delivery/surfactants.py`

 * *Files identical despite different names*

### Comparing `global_chem-1.8.1/global_chem/warfare/organophosphorous_nerve_agents.py` & `global_chem-1.8.1.1/global_chem/warfare/organophosphorous_nerve_agents.py`

 * *Files identical despite different names*

### Comparing `global_chem-1.8.1/global_chem.egg-info/PKG-INFO` & `global_chem-1.8.1.1/global_chem.egg-info/PKG-INFO`
...
### Comparing `global_chem-1.8.1/global_chem.egg-info/SOURCES.txt` & `global_chem-1.8.1.1/global_chem.egg-info/SOURCES.txt`
...
### Comparing `global_chem-1.8.1/global_chem.egg-info/requires.txt` & `global_chem-1.8.1.1/global_chem.egg-info/requires.txt`

 * *Files identical despite different names*

### Comparing `global_chem-1.8.1/setup.py` & `global_chem-1.8.1.1/setup.py`
