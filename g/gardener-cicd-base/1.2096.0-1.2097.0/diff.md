# Comparing `tmp/gardener-cicd-base-1.2096.0.tar.gz` & `tmp/gardener-cicd-base-1.2097.0.tar.gz`
...
## Comparing `gardener-cicd-base-1.2096.0.tar` & `gardener-cicd-base-1.2097.0.tar`
...
### Comparing `gardener-cicd-base-1.2096.0/LICENSE.md` & `gardener-cicd-base-1.2097.0/LICENSE.md`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/README.md` & `gardener-cicd-base-1.2097.0/README.md`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/ccc/__init__.py` & `gardener-cicd-base-1.2097.0/ccc/__init__.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/ccc/alicloud.py` & `gardener-cicd-base-1.2097.0/ccc/alicloud.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/ccc/aws.py` & `gardener-cicd-base-1.2097.0/ccc/aws.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/ccc/clamav.py` & `gardener-cicd-base-1.2097.0/ccc/clamav.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/ccc/concourse.py` & `gardener-cicd-base-1.2097.0/ccc/concourse.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/ccc/delivery.py` & `gardener-cicd-base-1.2097.0/ccc/delivery.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/ccc/elasticsearch.py` & `gardener-cicd-base-1.2097.0/ccc/elasticsearch.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/ccc/gcp.py` & `gardener-cicd-base-1.2097.0/ccc/gcp.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/ccc/github.py` & `gardener-cicd-base-1.2097.0/ccc/github.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/ccc/grafeas_model.py` & `gardener-cicd-base-1.2097.0/ccc/grafeas_model.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/ccc/jira.py` & `gardener-cicd-base-1.2097.0/ccc/jira.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/ccc/oci.py` & `gardener-cicd-base-1.2097.0/ccc/oci.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/ccc/protecode.py` & `gardener-cicd-base-1.2097.0/ccc/protecode.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/ccc/secrets_server.py` & `gardener-cicd-base-1.2097.0/ccc/secrets_server.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/ci/__init__.py` & `gardener-cicd-base-1.2097.0/ci/__init__.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/ci/log.py` & `gardener-cicd-base-1.2097.0/ci/log.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/ci/util.py` & `gardener-cicd-base-1.2097.0/ci/util.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/ctx.py` & `gardener-cicd-base-1.2097.0/ctx.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/gardener_cicd_base.egg-info/SOURCES.txt` & `gardener-cicd-base-1.2097.0/gardener_cicd_base.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/model/__init__.py` & `gardener-cicd-base-1.2097.0/model/__init__.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/model/alicloud.py` & `gardener-cicd-base-1.2097.0/model/alicloud.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/model/aws.py` & `gardener-cicd-base-1.2097.0/model/aws.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/model/azure.py` & `gardener-cicd-base-1.2097.0/model/azure.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/model/base.py` & `gardener-cicd-base-1.2097.0/model/base.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/model/btp_application_certificate.py` & `gardener-cicd-base-1.2097.0/model/btp_application_certificate.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/model/btp_service_binding.py` & `gardener-cicd-base-1.2097.0/model/btp_service_binding.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/model/ccee.py` & `gardener-cicd-base-1.2097.0/model/ccee.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/model/checkmarx.py` & `gardener-cicd-base-1.2097.0/model/checkmarx.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/model/clamav.py` & `gardener-cicd-base-1.2097.0/model/clamav.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/model/concourse.py` & `gardener-cicd-base-1.2097.0/model/concourse.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/model/container_registry.py` & `gardener-cicd-base-1.2097.0/model/container_registry.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/model/ctx_repository.py` & `gardener-cicd-base-1.2097.0/model/ctx_repository.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/model/delivery.py` & `gardener-cicd-base-1.2097.0/model/delivery.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/model/delivery_db.py` & `gardener-cicd-base-1.2097.0/model/delivery_db.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/model/docker.py` & `gardener-cicd-base-1.2097.0/model/docker.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/model/elasticsearch.py` & `gardener-cicd-base-1.2097.0/model/elasticsearch.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/model/email.py` & `gardener-cicd-base-1.2097.0/model/email.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/model/gardenlinux_cache.py` & `gardener-cicd-base-1.2097.0/model/gardenlinux_cache.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/model/gcp.py` & `gardener-cicd-base-1.2097.0/model/gcp.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/model/github.py` & `gardener-cicd-base-1.2097.0/model/github.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/model/gitlab.py` & `gardener-cicd-base-1.2097.0/model/gitlab.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/model/ingress.py` & `gardener-cicd-base-1.2097.0/model/ingress.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/model/jira.py` & `gardener-cicd-base-1.2097.0/model/jira.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/model/kubernetes.py` & `gardener-cicd-base-1.2097.0/model/kubernetes.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/model/oauth2_proxy.py` & `gardener-cicd-base-1.2097.0/model/oauth2_proxy.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/model/protecode.py` & `gardener-cicd-base-1.2097.0/model/protecode.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/model/proxy.py` & `gardener-cicd-base-1.2097.0/model/proxy.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/model/pypi.py` & `gardener-cicd-base-1.2097.0/model/pypi.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/model/secret.py` & `gardener-cicd-base-1.2097.0/model/secret.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/model/secrets_server.py` & `gardener-cicd-base-1.2097.0/model/secrets_server.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/model/signing_server.py` & `gardener-cicd-base-1.2097.0/model/signing_server.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/model/slack.py` & `gardener-cicd-base-1.2097.0/model/slack.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/model/tekton.py` & `gardener-cicd-base-1.2097.0/model/tekton.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/model/tekton_dashboard_ingress.py` & `gardener-cicd-base-1.2097.0/model/tekton_dashboard_ingress.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/model/victorops.py` & `gardener-cicd-base-1.2097.0/model/victorops.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/model/webhook_dispatcher.py` & `gardener-cicd-base-1.2097.0/model/webhook_dispatcher.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/setup.base.py` & `gardener-cicd-base-1.2097.0/setup.base.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/setup.py` & `gardener-cicd-base-1.2097.0/setup.py`

 * *Files identical despite different names*

### Comparing `gardener-cicd-base-1.2096.0/util.py` & `gardener-cicd-base-1.2097.0/util.py`
