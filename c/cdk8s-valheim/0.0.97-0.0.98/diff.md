# Comparing `tmp/cdk8s-valheim-0.0.97.tar.gz` & `tmp/cdk8s-valheim-0.0.98.tar.gz`
...
## Comparing `cdk8s-valheim-0.0.97.tar` & `cdk8s-valheim-0.0.98.tar`
...
### Comparing `cdk8s-valheim-0.0.97/LICENSE` & `cdk8s-valheim-0.0.98/LICENSE`

 * *Files identical despite different names*

### Comparing `cdk8s-valheim-0.0.97/PKG-INFO` & `cdk8s-valheim-0.0.98/PKG-INFO`
...
### Comparing `cdk8s-valheim-0.0.97/README.md` & `cdk8s-valheim-0.0.98/README.md`

 * *Files identical despite different names*

### Comparing `cdk8s-valheim-0.0.97/setup.py` & `cdk8s-valheim-0.0.98/setup.py`
...
### Comparing `cdk8s-valheim-0.0.97/src/cdk8s_valheim/__init__.py` & `cdk8s-valheim-0.0.98/src/cdk8s_valheim/__init__.py`

 * *Files identical despite different names*

### Comparing `cdk8s-valheim-0.0.97/src/cdk8s_valheim.egg-info/PKG-INFO` & `cdk8s-valheim-0.0.98/src/cdk8s_valheim.egg-info/PKG-INFO`
