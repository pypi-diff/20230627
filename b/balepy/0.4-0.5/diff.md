# Comparing `tmp/balepy-0.4.tar.gz` & `tmp/balepy-0.5.tar.gz`
...
## Comparing `balepy-0.4.tar` & `balepy-0.5.tar`
...
### Comparing `balepy-0.4/LICENSE` & `balepy-0.5/LICENSE`

 * *Files identical despite different names*

### Comparing `balepy-0.4/PKG-INFO` & `balepy-0.5/PKG-INFO`
...
### Comparing `balepy-0.4/balepy.egg-info/PKG-INFO` & `balepy-0.5/balepy.egg-info/PKG-INFO`
...
### Comparing `balepy-0.4/setup.py` & `balepy-0.5/setup.py`
