# Comparing `tmp/how_fake_accounts-0.2.0.tar.gz` & `tmp/how_fake_accounts-0.3.0.tar.gz`
...
## Comparing `how_fake_accounts-0.2.0.tar` & `how_fake_accounts-0.3.0.tar`
...
### Comparing `how_fake_accounts-0.2.0/how_fake_accounts/__main__.py` & `how_fake_accounts-0.3.0/how_fake_accounts/__main__.py`
...
### Comparing `how_fake_accounts-0.2.0/how_fake_accounts/core.py` & `how_fake_accounts-0.3.0/how_fake_accounts/core.py`
