# Comparing `tmp/tengu_py-0.6.2.tar.gz` & `tmp/tengu_py-0.6.3.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "tengu_py-0.6.2.tar", max compression
+gzip compressed data, was "tengu_py-0.6.3.tar", max compression
```

## Comparing `tengu_py-0.6.2.tar` & `tengu_py-0.6.3.tar`

### file list

```diff
@@ -1,9 +1,9 @@
--rw-r--r--   0        0        0     3783 2023-06-23 09:21:14.812532 tengu_py-0.6.2/README.md
--rw-r--r--   0        0        0     1567 2023-06-27 03:29:41.788245 tengu_py-0.6.2/pyproject.toml
--rw-r--r--   0        0        0      175 2023-06-14 09:42:26.699305 tengu_py-0.6.2/tengu/__init__.py
--rw-r--r--   0        0        0    20447 2023-06-27 03:29:30.737165 tengu_py-0.6.2/tengu/api.py
--rw-r--r--   0        0        0     7311 2023-05-31 05:29:35.614982 tengu_py-0.6.2/tengu/calcq.py
--rw-r--r--   0        0        0     4434 2023-05-31 05:29:35.614982 tengu_py-0.6.2/tengu/data.py
--rw-r--r--   0        0        0     7366 2023-06-23 09:23:19.909586 tengu_py-0.6.2/tengu/local.py
--rw-r--r--   0        0        0     4665 1970-01-01 00:00:00.000000 tengu_py-0.6.2/setup.py
--rw-r--r--   0        0        0     4367 1970-01-01 00:00:00.000000 tengu_py-0.6.2/PKG-INFO
...
### Comparing `tengu_py-0.6.2/README.md` & `tengu_py-0.6.3/README.md`

 * *Files identical despite different names*

### Comparing `tengu_py-0.6.2/pyproject.toml` & `tengu_py-0.6.3/pyproject.toml`
...
### Comparing `tengu_py-0.6.2/tengu/api.py` & `tengu_py-0.6.3/tengu/api.py`
...
### Comparing `tengu_py-0.6.2/tengu/calcq.py` & `tengu_py-0.6.3/tengu/calcq.py`

 * *Files identical despite different names*

### Comparing `tengu_py-0.6.2/tengu/data.py` & `tengu_py-0.6.3/tengu/data.py`

 * *Files identical despite different names*

### Comparing `tengu_py-0.6.2/tengu/local.py` & `tengu_py-0.6.3/tengu/local.py`

 * *Files identical despite different names*

### Comparing `tengu_py-0.6.2/setup.py` & `tengu_py-0.6.3/setup.py`
...
### Comparing `tengu_py-0.6.2/PKG-INFO` & `tengu_py-0.6.3/PKG-INFO`
