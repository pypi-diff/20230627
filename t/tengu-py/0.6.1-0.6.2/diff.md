# Comparing `tmp/tengu_py-0.6.1.tar.gz` & `tmp/tengu_py-0.6.2.tar.gz`
...
## Comparing `tengu_py-0.6.1.tar` & `tengu_py-0.6.2.tar`
...
### Comparing `tengu_py-0.6.1/README.md` & `tengu_py-0.6.2/README.md`

 * *Files identical despite different names*

### Comparing `tengu_py-0.6.1/pyproject.toml` & `tengu_py-0.6.2/pyproject.toml`
...
### Comparing `tengu_py-0.6.1/tengu/api.py` & `tengu_py-0.6.2/tengu/api.py`
...
### Comparing `tengu_py-0.6.1/tengu/calcq.py` & `tengu_py-0.6.2/tengu/calcq.py`

 * *Files identical despite different names*

### Comparing `tengu_py-0.6.1/tengu/data.py` & `tengu_py-0.6.2/tengu/data.py`

 * *Files identical despite different names*

### Comparing `tengu_py-0.6.1/tengu/local.py` & `tengu_py-0.6.2/tengu/local.py`

 * *Files identical despite different names*

### Comparing `tengu_py-0.6.1/setup.py` & `tengu_py-0.6.2/setup.py`
...
### Comparing `tengu_py-0.6.1/PKG-INFO` & `tengu_py-0.6.2/PKG-INFO`
