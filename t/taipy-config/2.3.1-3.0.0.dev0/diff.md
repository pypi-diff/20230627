# Comparing `tmp/taipy-config-2.3.1.tar.gz` & `tmp/taipy-config-3.0.0.dev0.tar.gz`
...
### Comparing `taipy-config-2.3.1/src/taipy/__init__.py` & `taipy-config-3.0.0.dev0/src/taipy/__init__.py`
