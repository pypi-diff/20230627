# Comparing `tmp/taipy-templates-2.3.1.tar.gz` & `tmp/taipy-templates-3.0.0.dev0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "taipy-templates-2.3.1.tar", last modified: Tue Jun 27 07:32:17 2023, max compression
+gzip compressed data, was "taipy-templates-3.0.0.dev0.tar", last modified: Fri Jun 23 10:12:23 2023, max compression
```

## Comparing `taipy-templates-2.3.1.tar` & `taipy-templates-3.0.0.dev0.tar`

### file list

```diff
@@ -1,47 +1,49 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-27 07:32:17.524828 taipy-templates-2.3.1/
--rw-r--r--   0 runner    (1001) docker     (123)    11353 2023-06-27 07:31:59.000000 taipy-templates-2.3.1/LICENSE
--rw-r--r--   0 runner    (1001) docker     (123)       40 2023-06-27 07:31:59.000000 taipy-templates-2.3.1/MANIFEST.in
--rw-r--r--   0 runner    (1001) docker     (123)     2900 2023-06-27 07:32:17.524828 taipy-templates-2.3.1/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)     2140 2023-06-27 07:31:59.000000 taipy-templates-2.3.1/README.md
--rw-r--r--   0 runner    (1001) docker     (123)       47 2023-06-27 07:31:59.000000 taipy-templates-2.3.1/pyproject.toml
--rw-r--r--   0 runner    (1001) docker     (123)       38 2023-06-27 07:32:17.524828 taipy-templates-2.3.1/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (123)     2176 2023-06-27 07:31:59.000000 taipy-templates-2.3.1/setup.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-27 07:32:17.520828 taipy-templates-2.3.1/src/
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-27 07:32:17.520828 taipy-templates-2.3.1/src/taipy/
--rw-r--r--   0 runner    (1001) docker     (123)     1286 2023-06-27 07:31:59.000000 taipy-templates-2.3.1/src/taipy/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-27 07:32:17.520828 taipy-templates-2.3.1/src/taipy/templates/
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-27 07:32:17.520828 taipy-templates-2.3.1/src/taipy/templates/multi-page-gui/
--rw-r--r--   0 runner    (1001) docker     (123)      134 2023-06-27 07:31:59.000000 taipy-templates-2.3.1/src/taipy/templates/multi-page-gui/cookiecutter.json
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-27 07:32:17.520828 taipy-templates-2.3.1/src/taipy/templates/multi-page-gui/hooks/
--rw-r--r--   0 runner    (1001) docker     (123)      763 2023-06-27 07:31:59.000000 taipy-templates-2.3.1/src/taipy/templates/multi-page-gui/hooks/post_gen_project.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-27 07:32:17.520828 taipy-templates-2.3.1/src/taipy/templates/multi-page-gui/{{cookiecutter.application_name}}/
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-27 07:32:17.520828 taipy-templates-2.3.1/src/taipy/templates/multi-page-gui/{{cookiecutter.application_name}}/pages/
--rw-r--r--   0 runner    (1001) docker     (123)       82 2023-06-27 07:31:59.000000 taipy-templates-2.3.1/src/taipy/templates/multi-page-gui/{{cookiecutter.application_name}}/pages/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-27 07:32:17.524828 taipy-templates-2.3.1/src/taipy/templates/multi-page-gui/{{cookiecutter.application_name}}/pages/page_1/
--rw-r--r--   0 runner    (1001) docker     (123)       27 2023-06-27 07:31:59.000000 taipy-templates-2.3.1/src/taipy/templates/multi-page-gui/{{cookiecutter.application_name}}/pages/page_1/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)        9 2023-06-27 07:31:59.000000 taipy-templates-2.3.1/src/taipy/templates/multi-page-gui/{{cookiecutter.application_name}}/pages/page_1/page_1.md
--rw-r--r--   0 runner    (1001) docker     (123)      255 2023-06-27 07:31:59.000000 taipy-templates-2.3.1/src/taipy/templates/multi-page-gui/{{cookiecutter.application_name}}/pages/page_1/page_1.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-27 07:32:17.524828 taipy-templates-2.3.1/src/taipy/templates/multi-page-gui/{{cookiecutter.application_name}}/pages/page_2/
--rw-r--r--   0 runner    (1001) docker     (123)       27 2023-06-27 07:31:59.000000 taipy-templates-2.3.1/src/taipy/templates/multi-page-gui/{{cookiecutter.application_name}}/pages/page_2/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)        9 2023-06-27 07:31:59.000000 taipy-templates-2.3.1/src/taipy/templates/multi-page-gui/{{cookiecutter.application_name}}/pages/page_2/page_2.md
--rw-r--r--   0 runner    (1001) docker     (123)      256 2023-06-27 07:31:59.000000 taipy-templates-2.3.1/src/taipy/templates/multi-page-gui/{{cookiecutter.application_name}}/pages/page_2/page_2.py
--rw-r--r--   0 runner    (1001) docker     (123)       11 2023-06-27 07:31:59.000000 taipy-templates-2.3.1/src/taipy/templates/multi-page-gui/{{cookiecutter.application_name}}/pages/root.md
--rw-r--r--   0 runner    (1001) docker     (123)      245 2023-06-27 07:31:59.000000 taipy-templates-2.3.1/src/taipy/templates/multi-page-gui/{{cookiecutter.application_name}}/pages/root.py
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-06-27 07:31:59.000000 taipy-templates-2.3.1/src/taipy/templates/multi-page-gui/{{cookiecutter.application_name}}/requirements.txt
--rw-r--r--   0 runner    (1001) docker     (123)      551 2023-06-27 07:31:59.000000 taipy-templates-2.3.1/src/taipy/templates/multi-page-gui/{{cookiecutter.application_name}}/{{cookiecutter.application_main_file}}
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-27 07:32:17.524828 taipy-templates-2.3.1/src/taipy/templates/taipy-default-template/
--rw-r--r--   0 runner    (1001) docker     (123)      134 2023-06-27 07:31:59.000000 taipy-templates-2.3.1/src/taipy/templates/taipy-default-template/cookiecutter.json
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-27 07:32:17.524828 taipy-templates-2.3.1/src/taipy/templates/taipy-default-template/hooks/
--rw-r--r--   0 runner    (1001) docker     (123)      763 2023-06-27 07:31:59.000000 taipy-templates-2.3.1/src/taipy/templates/taipy-default-template/hooks/post_gen_project.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-27 07:32:17.524828 taipy-templates-2.3.1/src/taipy/templates/taipy-default-template/{{cookiecutter.application_name}}/
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-27 07:32:17.524828 taipy-templates-2.3.1/src/taipy/templates/taipy-default-template/{{cookiecutter.application_name}}/images/
--rw-r--r--   0 runner    (1001) docker     (123)   411212 2023-06-27 07:31:59.000000 taipy-templates-2.3.1/src/taipy/templates/taipy-default-template/{{cookiecutter.application_name}}/images/taipy_logo.jpg
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-06-27 07:31:59.000000 taipy-templates-2.3.1/src/taipy/templates/taipy-default-template/{{cookiecutter.application_name}}/requirements.txt
--rw-r--r--   0 runner    (1001) docker     (123)     1014 2023-06-27 07:31:59.000000 taipy-templates-2.3.1/src/taipy/templates/taipy-default-template/{{cookiecutter.application_name}}/{{cookiecutter.application_main_file}}
--rw-r--r--   0 runner    (1001) docker     (123)       37 2023-06-27 07:31:59.000000 taipy-templates-2.3.1/src/taipy/templates/version.json
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-27 07:32:17.524828 taipy-templates-2.3.1/src/taipy_templates.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)     2900 2023-06-27 07:32:17.000000 taipy-templates-2.3.1/src/taipy_templates.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)     1878 2023-06-27 07:32:17.000000 taipy-templates-2.3.1/src/taipy_templates.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-06-27 07:32:17.000000 taipy-templates-2.3.1/src/taipy_templates.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-06-27 07:32:09.000000 taipy-templates-2.3.1/src/taipy_templates.egg-info/not-zip-safe
--rw-r--r--   0 runner    (1001) docker     (123)        6 2023-06-27 07:32:17.000000 taipy-templates-2.3.1/src/taipy_templates.egg-info/top_level.txt
...
### Comparing `taipy-templates-2.3.1/LICENSE` & `taipy-templates-3.0.0.dev0/LICENSE`

 * *Files identical despite different names*

### Comparing `taipy-templates-2.3.1/PKG-INFO` & `taipy-templates-3.0.0.dev0/PKG-INFO`
...
### Comparing `taipy-templates-2.3.1/README.md` & `taipy-templates-3.0.0.dev0/README.md`
...
### Comparing `taipy-templates-2.3.1/setup.py` & `taipy-templates-3.0.0.dev0/setup.py`

 * *Files identical despite different names*

### Comparing `taipy-templates-2.3.1/src/taipy/__init__.py` & `taipy-templates-3.0.0.dev0/src/taipy/__init__.py`

 * *Files identical despite different names*

### Comparing `taipy-templates-2.3.1/src/taipy/templates/multi-page-gui/hooks/post_gen_project.py` & `taipy-templates-3.0.0.dev0/src/taipy/templates/multi-page-gui/hooks/post_gen_project.py`

 * *Files identical despite different names*

### Comparing `taipy-templates-2.3.1/src/taipy/templates/multi-page-gui/{{cookiecutter.application_name}}/{{cookiecutter.application_main_file}}` & `taipy-templates-3.0.0.dev0/src/taipy/templates/multi-page-gui/{{cookiecutter.application_name}}/{{cookiecutter.application_main_file}}`

 * *Files identical despite different names*

### Comparing `taipy-templates-2.3.1/src/taipy/templates/taipy-default-template/hooks/post_gen_project.py` & `taipy-templates-3.0.0.dev0/src/taipy/templates/taipy-default-template/hooks/post_gen_project.py`

 * *Files identical despite different names*

### Comparing `taipy-templates-2.3.1/src/taipy/templates/taipy-default-template/{{cookiecutter.application_name}}/images/taipy_logo.jpg` & `taipy-templates-3.0.0.dev0/src/taipy/templates/taipy-default-template/{{cookiecutter.application_name}}/images/taipy_logo.jpg`

 * *Files identical despite different names*

### Comparing `taipy-templates-2.3.1/src/taipy/templates/taipy-default-template/{{cookiecutter.application_name}}/{{cookiecutter.application_main_file}}` & `taipy-templates-3.0.0.dev0/src/taipy/templates/taipy-default-template/{{cookiecutter.application_name}}/{{cookiecutter.application_main_file}}`

 * *Files identical despite different names*

### Comparing `taipy-templates-2.3.1/src/taipy_templates.egg-info/PKG-INFO` & `taipy-templates-3.0.0.dev0/src/taipy_templates.egg-info/PKG-INFO`
...
### Comparing `taipy-templates-2.3.1/src/taipy_templates.egg-info/SOURCES.txt` & `taipy-templates-3.0.0.dev0/src/taipy_templates.egg-info/SOURCES.txt`
