# Comparing `tmp/st_chat_message-0.3.2.tar.gz` & `tmp/st_chat_message-0.3.5.tar.gz`
...
## Comparing `st_chat_message-0.3.2.tar` & `st_chat_message-0.3.5.tar`
...
### Comparing `st_chat_message-0.3.2/README.md` & `st_chat_message-0.3.5/README.md`

 * *Files identical despite different names*

### Comparing `st_chat_message-0.3.2/pyproject.toml` & `st_chat_message-0.3.5/pyproject.toml`
...
### Comparing `st_chat_message-0.3.2/st_chat_message/__init__.py` & `st_chat_message-0.3.5/st_chat_message/__init__.py`

 * *Files identical despite different names*

### Comparing `st_chat_message-0.3.2/setup.py` & `st_chat_message-0.3.5/setup.py`
...
### Comparing `st_chat_message-0.3.2/PKG-INFO` & `st_chat_message-0.3.5/PKG-INFO`
