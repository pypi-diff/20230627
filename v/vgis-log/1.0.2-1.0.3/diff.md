# Comparing `tmp/vgis_log-1.0.2.tar.gz` & `tmp/vgis_log-1.0.3.tar.gz`
...
## Comparing `vgis_log-1.0.2.tar` & `vgis_log-1.0.3.tar`
...
### Comparing `vgis_log-1.0.2/PKG-INFO` & `vgis_log-1.0.3/PKG-INFO`
...
### Comparing `vgis_log-1.0.2/setup.py` & `vgis_log-1.0.3/setup.py`
...
### Comparing `vgis_log-1.0.2/vgis_log/logTools.py` & `vgis_log-1.0.3/vgis_log/logTools.py`

 * *Files identical despite different names*

### Comparing `vgis_log-1.0.2/vgis_log.egg-info/PKG-INFO` & `vgis_log-1.0.3/vgis_log.egg-info/PKG-INFO`
