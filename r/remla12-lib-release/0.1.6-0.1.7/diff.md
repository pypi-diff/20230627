# Comparing `tmp/remla12_lib_release-0.1.6.tar.gz` & `tmp/remla12_lib_release-0.1.7.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "remla12_lib_release-0.1.6.tar", last modified: Wed May 24 17:30:16 2023, max compression
+gzip compressed data, was "remla12_lib_release-0.1.7.tar", last modified: Tue Jun 27 08:14:18 2023, max compression
```

## Comparing `remla12_lib_release-0.1.6.tar` & `remla12_lib_release-0.1.7.tar`

### file list

```diff
@@ -1,13 +1,13 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-24 17:30:16.056059 remla12_lib_release-0.1.6/
--rw-r--r--   0 runner    (1001) docker     (123)      679 2023-05-24 17:30:16.056059 remla12_lib_release-0.1.6/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      449 2023-05-24 17:30:05.000000 remla12_lib_release-0.1.6/README.md
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-24 17:30:16.056059 remla12_lib_release-0.1.6/remla12_lib_release/
--rw-r--r--   0 runner    (1001) docker     (123)      101 2023-05-24 17:30:05.000000 remla12_lib_release-0.1.6/remla12_lib_release/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)      139 2023-05-24 17:30:05.000000 remla12_lib_release-0.1.6/remla12_lib_release/version_util.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-24 17:30:16.056059 remla12_lib_release-0.1.6/remla12_lib_release.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)      679 2023-05-24 17:30:15.000000 remla12_lib_release-0.1.6/remla12_lib_release.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      258 2023-05-24 17:30:16.000000 remla12_lib_release-0.1.6/remla12_lib_release.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-05-24 17:30:15.000000 remla12_lib_release-0.1.6/remla12_lib_release.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)       20 2023-05-24 17:30:15.000000 remla12_lib_release-0.1.6/remla12_lib_release.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (123)       38 2023-05-24 17:30:16.056059 remla12_lib_release-0.1.6/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (123)      455 2023-05-24 17:30:05.000000 remla12_lib_release-0.1.6/setup.py
...
### Comparing `remla12_lib_release-0.1.6/PKG-INFO` & `remla12_lib_release-0.1.7/PKG-INFO`
...
### Comparing `remla12_lib_release-0.1.6/remla12_lib_release.egg-info/PKG-INFO` & `remla12_lib_release-0.1.7/remla12_lib_release.egg-info/PKG-INFO`
