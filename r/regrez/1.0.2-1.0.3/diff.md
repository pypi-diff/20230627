# Comparing `tmp/regrez-1.0.2.tar.gz` & `tmp/regrez-1.0.3.tar.gz`
...
## Comparing `regrez-1.0.2.tar` & `regrez-1.0.3.tar`
...
### Comparing `regrez-1.0.2/PKG-INFO` & `regrez-1.0.3/PKG-INFO`
...
### Comparing `regrez-1.0.2/README.md` & `regrez-1.0.3/README.md`
...
### Comparing `regrez-1.0.2/regrez.egg-info/PKG-INFO` & `regrez-1.0.3/regrez.egg-info/PKG-INFO`
...
### Comparing `regrez-1.0.2/setup.py` & `regrez-1.0.3/setup.py`
